...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Updates the ""Goods for registration of import documents"" register:
	|- Fills in the ""Import document type"" attribute with the link to the metadata object ID for the ""Customs declaration (import)"" document.'");
