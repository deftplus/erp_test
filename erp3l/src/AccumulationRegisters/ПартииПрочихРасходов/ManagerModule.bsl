...
//
Функция ТекстЗапросаТаблицаВтПартииПрочихРасходов(ДополнительныеПоля = "") Экспорт
	...
	|	И (Статья.ВариантРаспределенияРасходовУпр = ЗНАЧЕНИЕ(Перечисление.ВариантыРаспределенияРасходов.НаСебестоимостьТоваров)
	|			И (&РаздельныйУчетТоваровПоНалогообложениюНДС
	//++ Локализация
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Updates the ""Material overheads for allocation"" register:
	|- Populates the ""Business transaction"" attribute for the ""Period-end transaction"" document records (transaction ""Recognition of lease payments in TA"").
	|- Register records on additional expenses by goods are transferred to the ""Other expenses"" register.'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	//++ НЕ УТ
	ВнеоборотныеАктивыЛокализация.ДополнитьСписокЗапросовРегистрацииДанныхКОбработкеРегистраПартииПрочихРасходов(СписокЗапросов);
	//-- НЕ УТ
