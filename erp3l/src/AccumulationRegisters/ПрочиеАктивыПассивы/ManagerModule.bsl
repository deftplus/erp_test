...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Updates the register ""Other assets/liabilities"" 
	|- fills in the new register ""Source kind""'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	//++ НЕ УТ
	ВнеоборотныеАктивыЛокализация.ДополнитьСписокЗапросовРегистрацииДанныхКОбработкеРегистраПрочиеАктивыПассивы(СписокЗапросов);
	//-- НЕ УТ
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru = 'Не удалось обработать движения по регистру ""Активы и пассивы"" документа ""%1"" по причине: %2';
									|en = 'Cannot process records for the register ""Assets and liabilities"" in document ""%1"". Reason: %2'");
