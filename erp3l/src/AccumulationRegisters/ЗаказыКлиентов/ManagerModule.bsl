...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет движения документа ""Передача товаров хранителю"" информационной базы в регистре накопления ""Заказы клиентов"" в разрезе ресурса ""Сумма"".
	...
	|en = 'Updates records of the ""Transfer of goods to bailee"" document in the ""Sales orders"" accumulation register of the infobase broken down by the ""Amount"" resource.
	|Updates records of the ""Purchase order — Subcontracting"" and ""Production stage"" documents in the ""Sales orders"" accumulation register of the infobase.'");
