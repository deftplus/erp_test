...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Updates the ""Expenses"" register
	|- Populates the ""Business transaction"" attribute for the ""Period-end transaction"" document records (the transaction ""Recognition of lease payments in TA"")
	|-Clears the ""Amount excluding VAT"" resource for register records with expense item, distributed in man. accounting for financial result.
	|- Adjusts register records of the ""Distribution of recyclable waste"" document.'");
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ВнеоборотныеАктивыЛокализация.ДополнитьСписокЗапросовРегистрацииДанныхКОбработкеРегистраПрочиеРасходы(СписокЗапросов);
	//-- НЕ УТ
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			ТекстСообщения = НСтр("ru = 'Не удалось обработать движения по регистру ""Прочие расходы"" документа ""%1"" по причине: %2';
									|en = 'Cannot process records for the register ""Expenses"" in document ""%1"". Reason: %2'");
