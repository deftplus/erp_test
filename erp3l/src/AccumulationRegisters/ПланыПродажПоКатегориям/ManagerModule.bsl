...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Updates the movements of the ""Sales forecasts by categories"" document by the ""Sales forecasts by categories"" accumulation register:
	| - deletes the movements for substituted plans
