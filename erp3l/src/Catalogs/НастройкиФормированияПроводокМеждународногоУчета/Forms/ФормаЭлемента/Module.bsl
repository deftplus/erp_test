...
Процедура УправлениеЭлементамиФормыПриСоздании()
	...
	СпособАннулированияПроводокДоступен = МеждународныйУчетОбщегоНазначения.ДоступноАннулированиеПроводокРеверсивнымиПроводками();
	ИзменятьСпособАннулированияПриИспользованииНастройки = Истина;
	
	Если СпособАннулированияПроводокДоступен
	И НЕ ИзменятьСпособАннулированияПриИспользованииНастройки Тогда
		СпособАннулированияПроводокДоступен = НЕ
			Справочники.НастройкиФормированияПроводокМеждународногоУчета.НастройкаФормированияПроводокИспользуется(Объект.Ссылка);
	КонецЕсли;
	
	Элементы.ГруппаСпособАннулированияПроводок.Доступность = СпособАннулированияПроводокДоступен;
