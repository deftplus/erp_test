...
#Область ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ""Ставка НДС"" и конвертирует шаблоны наименований в новый формат';
									|en = 'Fills in ""VAT rate"" attribute and converts description templates to a new format'");
...
#Область ОбработатьДанныеДляПереходаНаНовуюВерсиюДляНовогоЦенообразования
	...
	|""Settings of price key by variant""
	|""Settings of price key by batch""
	|""Settings of price key by package""'");
...
#Область ОбработатьДополнительныеРеквизитыНоменклатурыДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = 'Переносит настройки контроля заполнения дополнительных реквизитов из табличной части видов номенклатуры в элементы плана видов характеристик ""Дополнительные реквизиты и сведения""';
									|en = 'Transfers control settings for filling in additional attributes from the table of item kinds to the elements of the chart of variant types ""Additional attributes and information""'");
