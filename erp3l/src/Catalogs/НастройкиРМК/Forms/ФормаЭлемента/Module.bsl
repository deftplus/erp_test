...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ИспользоватьРозничныеПродажи
		...
		Если Не ЗначениеЗаполнено(КассаККМ) Тогда
			...
			|At least one fiscal cash register should be registered in the application to operate with the CWP setting.'");
		КонецЕсли;
	...
	Если Не ЗначениеЗаполнено(Объект.Ссылка)
		...
		Если Не ЗначениеЗаполнено(Касса) Тогда
			ВызватьИсключение НСтр("ru = 'В информационной базе не создано ни одной кассы.
			                             ...
			                             |At least one cash account should be registered in the application to operate with the CWP setting.'");
		КонецЕсли;
	КонецЕсли;
