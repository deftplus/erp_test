	   ...
	   И Не ЗаполненEmail() Тогда
		...
		ПоказатьВопрос(
			...
			НСтр("ru = 'Не заполнен адрес электронной почты. Продолжить?';
				|en = 'Не заполнен адрес электронной почты. Продолжить?'"),
			РежимДиалогаВопрос.ДаНет,
			,
			,
			НСтр("ru = 'Запись нового пользователя сервиса';
				|en = 'Запись нового пользователя сервиса'"));
		Возврат;
	КонецЕсли;
	...
	Если Объект.ПометкаУдаления И ВходВПрограммуРазрешен Тогда
		...
		ПоказатьПредупреждение(,
			НСтр("ru = 'Чтобы разрешить вход в программу, снимите
			           ...
			           |en = 'Чтобы разрешить вход в программу, снимите
			           |пометку на удаление с этого пользователя.'"));
		Возврат;
	КонецЕсли;
...
Процедура РазместитьЭлементыОповещенияУХ()
		// Флажок Отображать напоминания. 
	ДобавитьЭлементФлажок("ОтображатьНапоминанияУХ", ЭтаФорма, НСтр("ru = 'Отображать напоминания'"), 
		"Объект.ОтображатьНапоминания", Элементы.Страницы);
	// Группа E-mail.
	ГруппаEMail = ДобавитьГруппуЭлементов("ГруппаEMail", ЭтаФорма, НСтр("ru = 'E-mail'"), Элементы.Страницы);
	// Флажок Оповещать по E-mail. 
	ДобавитьЭлементФлажок("ОповещатьПоEmailУХ", ГруппаEMail, НСтр("ru = 'Оповещать по E-mail'"), 
		"Объект.ОповещатьПоEmail", Элементы.Страницы, 
	...
	НовыйЭлемент = Элементы.Вставить("ДекорацияEMailУХ", Тип("ДекорацияФормы"), ГруппаEMail);
	НовыйЭлемент.Вид		 = ВидДекорацииФормы.Надпись;
	НовыйЭлемент.Заголовок	 = НСтр("ru = 'Требуется настройка'");
	// Команда ОткрытьСистемнуюУчетнуюЗаписьУХ. 
	ЭтаФорма.Команды.Добавить("ОткрытьСистемнуюУчетнуюЗаписьУХ");
	НовыйЭлемент = Элементы.Добавить("ОткрытьСистемнуюУчетнуюЗаписьУХ", Тип("КнопкаФормы"), ГруппаEMail);
	НовыйЭлемент.ИмяКоманды	 = "ОткрытьСистемнуюУчетнуюЗаписьУХ";
	НовыйЭлемент.Заголовок	 = НСтр("ru = 'системной учетной записи'");
...
// МестоположениеВход.
&НаСервере
Функция ДобавитьГруппуЭлементов(НаименованиеРеквизитаВход, ГруппаРодительВход, ЗаголовокВход, МестоположениеВход)
