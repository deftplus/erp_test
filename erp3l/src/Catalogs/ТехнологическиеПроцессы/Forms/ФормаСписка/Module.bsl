...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокПользователей = ОбщегоНазначенияУТ.ПолучитьСписокПользователейСПравомДобавления(Метаданные.Справочники.ТехнологическиеПроцессы, НСтр("ru = '<Мои технологические процессы>';
																																				|en = '<My technological processes>'"));
