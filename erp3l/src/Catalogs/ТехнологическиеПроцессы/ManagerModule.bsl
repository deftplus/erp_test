...
Функция ПоследовательностьОперацийПравильная(ТехнологическийПроцесс, Отказ = Ложь) Экспорт
	...
	ПоследовательностьПравильная = УправлениеДаннымиОбИзделиях.ПоследовательностьОперацийПравильная(ТехнологическийПроцесс, СтруктураПараметров, СтруктураСообщений, Отказ);
...
Функция ВыгрузитьДанныеДляКонструктораФормул(Объект, ИмяТЧ, ДанныеСтроки = Неопределено) Экспорт
	...
	ОписаниеИсточников = Справочники.ТехнологическиеПроцессы.ОписаниеИсточниковДанныхОперандов(Объект);
...
Функция СформироватьПечатнуюФормуТехнологическогоПроцесса(МассивОбъектов, ОбъектыПечати)
	...
	Пока ВыборкаШапка.Следующий() Цикл
		...
		Область.Параметры.ТекстЗаголовка = НСтр("ru = 'Технологический процесс ';
												|en = 'Technological process '",
			ОбщегоНазначения.КодОсновногоЯзыка()) + ДанныеДляПечати.ВыборкаШапка.Представление;
