...
Функция ТекстЗапросаНеобеспеченныхНазначенийОбеспечено(ПараметрыФормированияЗапроса) Экспорт
	...
	|		РаспределениеЗапасов.КОбеспечению + РаспределениеЗапасов.ОтложитьОбеспечение + РаспределениеЗапасов.Резервировать КАК Потребность,
	|		РаспределениеЗапасов.КОбеспечению + РаспределениеЗапасов.ОтложитьОбеспечение + РаспределениеЗапасов.Резервировать - РаспределениеЗапасов.Запас КАК КЗаказу,
...
Функция ДобавитьОписаниеОбеспечениеЗаказовПоВалюте(МакетФормы, ДобавитьСторно, Префикс)
	...
	ТекстЗапроса = 
		...
		|	РаспределениеЗапасов.КОбеспечению + РаспределениеЗапасов.ОтложитьОбеспечение + РаспределениеЗапасов.Резервировать - РаспределениеЗапасов.Запас КАК ПрефиксПотребность,
		|	РаспределениеЗапасов.КОбеспечению + РаспределениеЗапасов.ОтложитьОбеспечение + РаспределениеЗапасов.Резервировать + РаспределениеЗапасов.НеОбеспечивать КАК ПрефиксАрхивное
	...
	Если ДобавитьСторно Тогда
		...
		ТекстЗапросаСторно =
			...
			|	&ПоляВыбораПредшествующие,
			|	СУММА(Сведения.Распределено) КАК ПрефиксВНаличии,
...
Функция ДобавитьОписаниеОбеспечениеЗаказов(МакетФормы, ДобавитьСторно, Префикс = "")
	...
	Если ДобавитьСторно Тогда
		...
		ТекстЗапросаСторно =
			...
			|				0
			|		КОНЕЦ
			|		+ Движения.Поступило + Движения.ПоступитКДате + Движения.ПоставкаНаСогласовании - Движения.Отгрузить - Движения.КОбеспечению - Движения.Резервировать КАК ПрефиксПотребность,
			|	0 КАК ПрефиксАрхивное
			|	,&ПоляВыбораПоследующие
			|ИЗ
			|	РегистрНакопления.РаспределениеЗапасовДвижения КАК Движения
