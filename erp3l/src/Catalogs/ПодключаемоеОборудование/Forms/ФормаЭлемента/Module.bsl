	...
	Для Каждого ПараметрРегистрации Из Объект.ПараметрыРегистрации Цикл
		...
		ИначеЕсли НаименованиеПараметра = "ЗаводскойНомерФН" Тогда
			НаименованиеПараметра = НСтр("ru = 'Заводской номер ФН';
										|en = 'Fiscal cash register identification number'")
		...
		ИначеЕсли НаименованиеПараметра = "ВерсияФФДФН" Тогда
			НаименованиеПараметра = НСтр("ru = 'Версия ФФД ФН';
										|en = 'FDF fiscal cash register version'")
		// ФФД 1.05 и ФФД  1.1
		...
		ИначеЕсли НаименованиеПараметра = "ПризнакПримененияЛомбардами" Тогда
			НаименованиеПараметра = НСтр("ru = 'Признак применения ломбардами';
										|en = 'Indicates application by lombards'")
		ИначеЕсли НаименованиеПараметра = "ПризнакДеятельностиПоСтрахованию" Тогда
			НаименованиеПараметра = НСтр("ru = 'Признак деятельности по страхованию';
										|en = 'Indicates insurance activities'")
