...
Процедура ПроверитьПриоритет(Отказ)
	...
	Если Выборка.Следующий() Тогда
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Справочник.КлючевыеОперации.МодульОбъекта.ПередЗаписью';
										|en = 'Catalog.KeyOperations.ObjectModule.BeforeWriting'", ОбщегоНазначения.КодОсновногоЯзыка()),
