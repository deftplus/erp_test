...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит Ставка НДС, а также заполняет реквизит
									|""Единица измерения ТН ВЭД"" в соответствии с классификатором ТН ВЭД';
									|en = 'Populates the VAT rate attribute. Also populates
									| ""FEACN unit of measure"" attribute in accordance with the FEACN classifier'");
...
Процедура ОбработатьДанныеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|	ГДЕ
	|		ДанныеНоменклатуры.СтавкаНДС = ЗНАЧЕНИЕ(Справочник.СтавкиНДС.ПустаяСсылка)
