...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'The handler populates the ""VAT rate"" attribute and ""Foreign currency transaction"" flag.
	|It also generates items in the ""AR/AP objects"" catalog for contracts where AR/AP is defined as ""Contract for prepayment and invoice"".'");
