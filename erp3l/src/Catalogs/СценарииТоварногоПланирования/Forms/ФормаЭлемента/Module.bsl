...
Процедура Подключаемый_РежимФормированияПотребностейПланомЗакупокПриИзменении(Элемент)
	...
	Если ВозможностьПланированияПотребностейДляКЗ Тогда
		Если ЭтоПланированияПотребностей(Объект.РежимФормированияПотребностейПланомЗакупок) Тогда
		...
		НастроитьЗависимыеЭлементыФормы(ЭтаФорма, "РежимФормированияПотребностейПланомЗакупок");
	КонецЕсли;
