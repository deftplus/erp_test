...
Процедура ПриЧтенииСозданииНаСервере()
	...
	РедакторПроизводственногоПроцесса.НастроитьВидимостьДоступностьЭлементовОперации(Объект, ЭтотОбъект);
	РедакторПроизводственногоПроцесса.НастроитьПараметрыВыбораРабочихЦентров(Объект, ЭтотОбъект);
