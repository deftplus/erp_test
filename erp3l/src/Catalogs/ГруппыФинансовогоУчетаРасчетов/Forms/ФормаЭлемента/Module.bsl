...
Процедура Подключаемый_ВыполнитьПереопределяемуюКоманду(Команда)
	...
	//++ НЕ УТ
	НастройкаСчетовУчетаКлиент.ВыполнитьПереопределяемуюКоманду(ЭтотОбъект, Команда);
	//-- НЕ УТ
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	Если ИспользоватьКомиссиюПриПродажах 
		...
		СписокВыбора.Добавить(3, НСтр("ru = 'комиссионерами / агентами';
										|en = 'by agents or commission agents'"));
	КонецЕсли;
	...
	//++ НЕ УТ
	Если ИспользоватьДоговорыАренды 
		ИЛИ Объект.РасчетыСАрендодателями Тогда
