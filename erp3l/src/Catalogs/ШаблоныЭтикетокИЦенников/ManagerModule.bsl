...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Конвертирует выражения шаблонов в макетах этикеток и ценников в новый формат';
									|en = 'Converts template expressions in label and price tag layouts to a new format'");
...
Процедура ОбработатьВыраженияВЯчейкахШаблонаДляПереходаНаНовыеФормулы(СправочникОбъект, ОбъектИзменен)
	...
	Если НЕ СправочникОбъект.УдалитьПереходНаНовыеФормулыВыполнен Тогда
		...
		//++ НЕ УТ
		//++ Локализация
		ИначеЕсли СправочникОбъект.Назначение = Перечисления.НазначенияШаблоновЭтикетокИЦенников.ЭтикеткаТМЦВЭксплуатацииЛента
			ИЛИ СправочникОбъект.Назначение = Перечисления.НазначенияШаблоновЭтикетокИЦенников.ЭтикеткаТМЦВЭксплуатацииБумага Тогда
			СхемаКомпоновкиДанных = Обработки.ПечатьЭтикетокТМЦВЭксплуатации.ПолучитьМакет("ПоляШаблонаТМЦВЭксплуатации");
		//-- Локализация
		ИначеЕсли СправочникОбъект.Назначение = Перечисления.НазначенияШаблоновЭтикетокИЦенников.ЭтикеткаОбъектаЭксплуатацииЛента
			ИЛИ СправочникОбъект.Назначение = Перечисления.НазначенияШаблоновЭтикетокИЦенников.ЭтикеткаОбъектаЭксплуатацииБумага Тогда
			СхемаКомпоновкиДанных = Обработки.ПечатьЭтикетокОбъектовЭксплуатации.ПолучитьМакет("ПоляШаблонаОбъектыЭксплуатации");
		//-- НЕ УТ
		//++ НЕ УТКА
		ИначеЕсли СправочникОбъект.Назначение = Перечисления.НазначенияШаблоновЭтикетокИЦенников.ЭтикеткаУзлаОбъектаЭксплуатацииЛента
			ИЛИ СправочникОбъект.Назначение = Перечисления.НазначенияШаблоновЭтикетокИЦенников.ЭтикеткаУзлаОбъектаЭксплуатацииБумага Тогда
		...
		Если СхемаКомпоновкиДанных = Неопределено Тогда
			...
			ТекстОшибки = НСтр("ru = 'Не удалось определить схему компоновки данных';
								|en = 'Cannot determine data composition schema'");
