...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполнение реквизита ""Хозяйственная операция"" и разделение видов планов на сборку/разборку если для вида плана есть планы сборки и разборки';
									|en = 'Fills in the ""Business transaction"" attribute and separates the plan profiles for assembly/dissasembly, if there are assembly and dissasembly plans for the plan profile'");
