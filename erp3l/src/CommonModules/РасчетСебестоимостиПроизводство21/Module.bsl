...
Функция ТекстТрудозатратыВыпускиПоЗаказам()
	Возврат
		...
		|		И АналитикаУчетаПартий.НалогообложениеНДС = ЗНАЧЕНИЕ(Перечисление.ТипыНалогообложенияНДС.ПустаяСсылка)
		|		И ВЫБОР
		...
		|				ТОГДА АналитикаУчетаПартий.ВидЦенности = Статьи.ВидЦенностиНДС
