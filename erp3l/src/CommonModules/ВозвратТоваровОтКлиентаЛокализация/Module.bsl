...
Функция ПозицииНоменклатурыПоДокументу(ДокументСсылка) Экспорт
	...
	Запрос.Текст = "
	|ВЫБРАТЬ
	|	ТаблицаТоваровВозвратТоваровОтКлиента.Номенклатура,
	|	ТаблицаТоваровВозвратТоваровОтКлиента.Характеристика,
	|	ТаблицаТоваровВозвратТоваровОтКлиента.Упаковка,
	|	ВЫБОР
	|		КОГДА ТаблицаТоваровВозвратТоваровОтКлиента.КоличествоУпаковок = 0
	|			ТОГДА 1
	|		ИНАЧЕ ТаблицаТоваровВозвратТоваровОтКлиента.КоличествоУпаковок
	|	КОНЕЦ КАК Количество,
	|	ВЫБОР
	|		КОГДА ТаблицаТоваровВозвратТоваровОтКлиента.КоличествоУпаковок = 0
	|			ТОГДА ТаблицаТоваровВозвратТоваровОтКлиента.СуммаБезНДС + ТаблицаТоваровВозвратТоваровОтКлиента.СуммаНДС
	|		ИНАЧЕ ВЫРАЗИТЬ((ТаблицаТоваровВозвратТоваровОтКлиента.СуммаБезНДС + ТаблицаТоваровВозвратТоваровОтКлиента.СуммаНДС) /
	|				ТаблицаТоваровВозвратТоваровОтКлиента.КоличествоУпаковок КАК ЧИСЛО(31,2))
	|	КОНЕЦ КАК Цена,
	|	ТаблицаТоваровВозвратТоваровОтКлиента.СуммаБезНДС + ТаблицаТоваровВозвратТоваровОтКлиента.СуммаНДС КАК Сумма,
	|	ТаблицаТоваровВозвратТоваровОтКлиента.СтавкаНДС КАК СтавкаНДС,
	|	ТаблицаТоваровВозвратТоваровОтКлиента.СуммаНДС КАК СуммаНДС
	|ПОМЕСТИТЬ ТаблицаНоменклатуры
	|ИЗ
	|	ТаблицаТоваровВозвратТоваровОтКлиента КАК ТаблицаТоваровВозвратТоваровОтКлиента
	|ГДЕ
	|	ТаблицаТоваровВозвратТоваровОтКлиента.ДоКорректировки = ЛОЖЬ
	|	И (НЕ &ВернутьМногооборотнуюТару
	|		ИЛИ (Не &ТребуетсяЗалогЗаТару
	|			И ТаблицаТоваровВозвратТоваровОтКлиента.Номенклатура.ТипНоменклатуры <> ЗНАЧЕНИЕ(Перечисление.ТипыНоменклатуры.МногооборотнаяТара))
