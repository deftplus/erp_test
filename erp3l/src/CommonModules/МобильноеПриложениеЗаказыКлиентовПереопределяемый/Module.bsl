...
Процедура ЗаписатьКонтактнуюИнформацию(ИнформацияПоОбъекту, Знач СсылкаНаОбъект, Знач ИмяСправочника)
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "&СправочникИмяСправочникаКонтактнаяИнформация", "Справочник." + ИмяСправочника + ".КонтактнаяИнформация");
...
Процедура ЗаписатьДополнительныеРеквизиты(ИнформацияПоОбъекту, Знач СсылкаНаОбъект, Знач ИмяОбъекта, Знач ЭтоСправочник)
	...
	Запрос.Текст = СтрЗаменить(Запрос.Текст, "&ТаблицаОбъекта", ТаблицаОбъекта);
	Запрос.УстановитьПараметр("Ссылка", СсылкаНаОбъект);
	Результат = Запрос.Выполнить().Выгрузить();
