...
Функция НовыйIAMТокен()
	...
	Если Не РезультатЗапроса.ЗапросВыполнен Тогда
		ВызватьИсключение ТекстОшибки(НСтр("ru = 'Не удалось авторизоваться в сервисе Яндекс.Переводчик.';
											|en = 'Cannot authorize to Yandex.Translate.'"));
	КонецЕсли;
...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	Настройки.ИнструкцияПоПодключению = СтроковыеФункции.ФорматированнаяСтрока(НСтр(
		...
		|en = 'How to set up:
		|1. Register with <a href = ""https://cloud.yandex.ru/"">Yandex.Cloud</a> and activate a <a href = ""https://console.cloud.yandex.ru/billing"">billing account</a>.
		|2. Go to <a href = ""https://oauth.yandex.ru/authorize?response_type=token&client_id=1a6990aa636648e9b2ef855fa7bec2fb"">Yandex OAuth</a> and copy the alphanumeric string into the <b>OAuth token</b> field.
		|3. Go to <a href = ""https://console.cloud.yandex.ru/"">Yandex.Cloud management console</a>. In the <b>Your resources</b> list to the right of the <b>default</b> directory, copy the alphanumeric string and paste it in the <b>Directory ID</b> field.'"));
