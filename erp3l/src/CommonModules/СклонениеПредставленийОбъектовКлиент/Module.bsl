...
Процедура ПриИзмененииПредставления(Форма) Экспорт
	...
	ТекстСообщения = НСтр("ru = 'Метод СклонениеПредставленийОбъектовКлиент.ПриИзмененииПредставления более не поддерживается. 
                           ...
                           |en = 'The DeclensionObjectsPresentationClient.OnChangePresentation method is no longer supported. 
                           | Use the DeclensionObjectsPresentationClient.DeclinePresentation method instead.'");
