...
// Выполняет поиск данных в сервисе по строке или штихкодам.
// 
// Параметры:
...
Функция ПараметрыЗаполненияФормыНоменклатурыПодготовлены(Знач ИдентификаторНоменклатуры, 
	...
	Перем ОсновныеРеквизиты, ДополнительныеРеквизиты;
	...
	РеквизитыПодготовлены = ВидНоменклатурыИДополнительныеРеквизитыПодготовлены(ТаблицаОтличийРеквизитов, 
		ИдентификаторКатегории, СтрокаДанных, ДополнительныеРеквизиты);
...
Процедура ДобавитьДополнительныеРеквизитыКОбновляемым(ОбновляемыеРеквизиты, 
	...
	//ВызовИзФормы = (ОбновляемыеРеквизиты.Колонки.Найти("ТолькоПросмотр") <> Неопределено);
	...
	Для каждого ТекущийРеквизит Из СтрокаДанных.ДополнительныеРеквизиты Цикл
		...
		Если ВызовИзФормы И 
			ЭтоСсылочноеЗначение И ТекущийРеквизит.ЗначениеИнформационнойБазы = Неопределено Тогда
...
Функция ВидНоменклатурыИДополнительныеРеквизитыПодготовлены(ОбновляемыеРеквизиты, 
	ИдентификаторКатегории, СтрокаДанных, ЗначенияРеквизитов)
	...
	ДобавитьСтрокуВТаблицуОтличий(ОбновляемыеРеквизиты, "ВидНоменклатуры",
		ВидНоменклатурыДляЗаполнения,, "Вид номенклатуры");
