...
#Область Себестоимость // (Дт 90.02, 91.02 :: Кт 20.01, 23)
	...
	|	НЕОПРЕДЕЛЕНО КАК ИдентификаторСтроки,
	|
	|	ЕСТЬNULL(Стоимости.Сумма - Стоимости.СуммаЗабалансовая, Стоимости22.Сумма - Стоимости22.СуммаЗабалансовая) КАК Сумма,
	...
	|	0 КАК ВалютнаяСуммаДт,
	|	Строки.Количество КАК КоличествоДт,
	|	ЕСТЬNULL(Стоимости.СуммаНУ - Стоимости.СуммаЗабалансовая, Стоимости22.СуммаНУ - Стоимости22.СуммаЗабалансовая) КАК СуммаНУДт,
	...
	|	0 КАК ВалютнаяСуммаКт,
	|	0 КАК КоличествоКт,
	|	ЕСТЬNULL(Стоимости.СуммаНУ - Стоимости.СуммаЗабалансовая, Стоимости22.СуммаНУ - Стоимости22.СуммаЗабалансовая) КАК СуммаНУКт,
