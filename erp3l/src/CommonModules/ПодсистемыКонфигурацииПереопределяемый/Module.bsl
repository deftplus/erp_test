...
Процедура ПриДобавленииПодсистем(МодулиПодсистем) Экспорт
	...
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыУХ");
	                       
	МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыЕХ");
	
	// ОПК
	Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ПланированиеИКонтрольСлужебный") Тогда // Есть подсистема ОПК
		МодулиПодсистем.Добавить("ОбновлениеИнформационнойБазыОПК");
	КонецЕсли;
	// Конец ОПК
