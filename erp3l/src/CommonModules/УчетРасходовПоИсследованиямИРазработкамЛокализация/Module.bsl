...
// см. РеглУчетПроведениеСервер.ВернутьДокументыКОтражению
//
...
Функция ТекстЗапросаУчетнаяПолитикаБУ() Экспорт
	...
	|	ЛОЖЬ 															КАК ПрименяетсяФСБУНематериальныеАктивы,
	...
	"ВЫБРАТЬ
	|	ГоловныеОрганизации.Организация 							КАК Организация,
	|	ТаблицаСрезПоследних.ПрименяетсяФСБУНематериальныеАктивы	КАК ПрименяетсяФСБУНематериальныеАктивы,
...
Функция ТекстЗапросаУчетныеПолитикиБУ() Экспорт
	...
	|	УчетнаяПолитикаБУ.ПрименяетсяФСБУНематериальныеАктивы	КАК ПрименяетсяПризнаниеПоИсследованиям
	|ПОМЕСТИТЬ вт_УчетныеПолитикиБУ
	|ИЗ
