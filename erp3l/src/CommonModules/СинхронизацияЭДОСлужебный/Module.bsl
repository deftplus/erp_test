	...
	Если ОбщегоНазначения.ПодсистемаСуществует("ЭлектронноеВзаимодействие.ЭлектронноеАктированиеЕИС") Тогда
		...
		Если МодульЭлектронноеАктированиеЕИС.
			...
			И МодульЭлектронноеАктированиеЕИС.
				ЕстьВозможностьОтправкиПолученияЭД() Тогда
	...
	Для Каждого ТранспортныйКонтейнер Из ТранспортныеКонтейнеры Цикл
		...
		Попытка
			...
			ИначеЕсли ЕстьЭлектронноеАктированиеЕИС
				...
				РезультатОтправкиКонтейнера = МодульЭлектронноеАктированиеЕИС.
					ОтправитьКонтейнерЧерезСерверЕИС(ПараметрыОтправки, КонтекстДиагностики);
			КонецЕсли;
