...
Процедура ПодготовитьГруппуПодтвержденияЭлементы(КонтекстФормы)
	...
	ЭлементФормы = ДобавитьРазделитель(ЭлементыФормы, ЕстьРазделители, "ПодтверждениеРазделитель1", КонтейнерОбщий, "1", "Первый", НСтр("ru = 'Данные сертификата';
																																		|en = 'Certificate data'", КодЯзыка));
	ЭлементФормы = ДобавитьРазделитель(ЭлементыФормы, ЕстьРазделители, "ПодтверждениеРазделитель2", КонтейнерПервый, "2", , НСтр("ru = 'Данные учетной записи';
																																|en = 'Account data'", КодЯзыка));
	...
	ЭлементФормы = ДобавитьРазделитель(ЭлементыФормы, ЕстьРазделители, "ПодтверждениеРазделитель3", КонтейнерПервый, "3", , НСтр("ru = 'Подтверждение операции';
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеЛогин", НСтр("ru = 'Уч. запись';
																			|en = 'Account'", КодЯзыка), ГруппаПодтвержденияУчетнаяЗапись, , "ПолеВвода");
	УстановитьПутьКДанным(ЭлементФормы, "Логин");
	ЭлементФормы.ТолькоПросмотр = Истина;
	
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеПредставлениеСертификата", НСтр("ru = 'Сертификат авторизации';
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеПароль", НСтр("ru = 'Пароль';
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеЗапомнитьПарольЛогина", НСтр("ru = 'Запомнить пароль';
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеАвторизацияВеб", НСтр("ru = 'Авторизация';
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеСпособПодтверждения", НСтр("ru = 'Способ подтверждения';
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеИнформацияСервера", НСтр("ru = 'Сообщение сервиса';
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеКодПодтверждения", НСтр("ru = 'Код подтверждения';
	...
	ГруппаИнструкции = ДобавитьГруппу(ЭлементыФормы, "ПодтверждениеИнструкция", ГруппаПодтвержденияКод, , , НСтр("ru = 'Требуется помощь?';
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеПовторить", НСтр("ru = 'Выслать заново';
																				|en = 'Send again'", КодЯзыка), ГруппаПодтвержденияКод, "КнопкаФормы");
	...
	ЭлементФормы = ДобавитьЭлемент(ЭлементыФормы, "ПодтверждениеАнимация", НСтр("ru = 'Анимация';
