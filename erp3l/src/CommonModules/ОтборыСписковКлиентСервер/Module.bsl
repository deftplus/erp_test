...
Процедура ПриИзмененииОтбораПоАктуальности(Список, Актуальность, ДатаСобытия) Экспорт
	...
	ИначеЕсли СтрНайти(Актуальность, НСтр("ru = 'Истекает на';
		...
		Актуальность = НСтр("ru = 'Истекает на %ДатаСобытия%';
...
Процедура ЗаполнитьСписокВыбораОтбораПоАктуальности(СписокВыбораАктуальности) Экспорт
	...
	СписокВыбораАктуальности.Добавить(НСтр("ru = 'Не просрочен';
											|en = 'Not overdue'"),        НСтр("ru = 'Не просрочен';
																			|en = 'Not overdue'"));
	СписокВыбораАктуальности.Добавить(НСтр("ru = 'Просрочен';
											|en = 'Overdue'"),           НСтр("ru = 'Просрочен';
																			|en = 'Overdue'"));
	СписокВыбораАктуальности.Добавить(НСтр("ru = 'Истекает на дату';
											|en = 'Expires on'"),    НСтр("ru = 'Истекает на дату...';
																			|en = 'Expires on date ...'"));
	СписокВыбораАктуальности.Добавить(НСтр("ru = 'Сегодня';
											|en = 'Today'"),             НСтр("ru = 'Сегодня';
																			|en = 'Today'"));
	СписокВыбораАктуальности.Добавить(НСтр("ru = 'Завтра';
											|en = 'Tomorrow'"),              НСтр("ru = 'Завтра';
																			|en = 'Tomorrow'"));
	СписокВыбораАктуальности.Добавить(НСтр("ru = 'Послезавтра';
											|en = 'The day after tomorrow'"),         НСтр("ru = 'Послезавтра';
																			|en = 'The day after tomorrow'"));
	СписокВыбораАктуальности.Добавить(НСтр("ru = 'Через неделю';
