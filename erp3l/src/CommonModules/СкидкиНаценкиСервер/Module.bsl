...
//   * ПараметрыРасчета - Структура - Структура параметров расчета.
//
Функция РассчитатьПоОтчетуДавальцу(Объект, ВходныеПараметры)
...
//
Процедура ПрименитьРезультатРасчетаКОтчетуДавальцу(Объект, ПримененныеСкидкиНаценки) 
...
Функция НеобходимаРегистрация(СсылкаДляПроверки) Экспорт
	...
	Если ЗначениеЗаполнено(НастройкиКомпоновкиДанных) 
		...
		Возврат (СтрНайти(НастройкиКомпоновкиДанных.Запрос.ТекстЗапроса, "#123456789#") = 0);
...
// * ЗначениеПоказателя - Неопределено, Число -
// 
