...
Процедура ОбновитьУведомленияОНеобходимостиПодписанияПечатныхФорм() Экспорт
	...
	Если ЗначениеЗаполнено(Исполнители) Тогда
		...
		РегистрыСведений.ЗапланированныеДействияСПечатнымиФормами.ОбновитьУведомленияОНеобходимостиПодписанияПечатныхФорм(Исполнители);
