...
Функция ВыборкаДляСопоставленияНоменклатуры(СсылкаНаОбъект) Экспорт
	...
	Иначе
		НетТЧТовары = Ложь;
		//++ НЕ УТКА
		Если ТипЗнч(СсылкаНаОбъект) = Тип("ДокументСсылка.ОтчетДавальцу") Тогда
			НетТЧТовары = Истина;
		КонецЕсли;
		//-- НЕ УТКА
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляются данные справочника номенклатура контрагентов.';
									|en = 'Updating product cross references catalog data.'");
...
Функция ТекстЗапросаТаблицыАктуальностиНоменклатурыКонтрагентов()
	...
	//++ НЕ УТ
	ТабличныеЧастиНеактуальнойНоменклатуры.Добавить("Документ.ВыкупПринятыхНаХранениеТоваров.Товары");
	ТабличныеЧастиНеактуальнойНоменклатуры.Добавить("Документ.ОтгрузкаТоваровСХранения.Товары");
	ТабличныеЧастиНеактуальнойНоменклатуры.Добавить("Документ.ПриемкаТоваровНаХранение.Товары");
	ТабличныеЧастиНеактуальнойНоменклатуры.Добавить("Документ.СписаниеПринятыхНаХранениеТоваров.Товары");
	//-- НЕ УТ
