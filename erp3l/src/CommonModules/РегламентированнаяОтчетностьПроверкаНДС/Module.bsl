...
// декларации по НДС. Предназначена для редакций декларации по НДС, соответствующих формам "ФормаОтчета2022Кв1",
// "ФормаОтчета2021Кв3", "ФормаОтчета2020Кв4", "ФормаОтчета2019Кв1" и "ФормаОтчета2017Кв1" отчета
...
Процедура ПроверитьЗаполнение_Раздел1(КонтекстВыполнения)
	...
	Если ВРег(КонтекстВыполнения.ИмяФормы) = ВРег("ФормаОтчета2022Кв1") Тогда
	...
	Если ВРег(КонтекстВыполнения.ИмяФормы) = ВРег("ФормаОтчета2022Кв1")
...
Процедура ПроверитьЗаполнение_Раздел2(КонтекстВыполнения)
	...
	Если ВРег(СокрЛП(КонтекстВыполнения.ИмяФормы)) = ВРег("ФормаОтчета2022Кв1")
