...
Процедура УдалитьИсправленияИзСкрипта() Экспорт
	...
	Если СтандартныеПодсистемыСервер.ЭтоБазоваяВерсияКонфигурации()
		...
		ТекстСообщения = НСтр("ru = 'Удаление исправлений до запуска обновления программы не выполнялось.
			...
			|en = 'Before updating the application, you need to clean up the patches.
			|This version of 1C:Enterprise doesn''t support patch management. Update to a later version.'");
...
Функция СообщенияСкриптов()
	...
	Сообщения.Вставить("[СообщениеОтказЛогирования]", НСтр("ru = 'Исключение в writeEventLog: {0}, {1}';
															|en = 'Exception in writeEventLog: {0}, {1}'"));
	...
	Сообщения.Вставить("[СообщениеФайлБазыНеСуществует]", НСтр("ru = 'Файл базы данных 1Cv8.1CD не существует по пути: {0}';
																|en = '1Cv8.1CD database file does not exist at: {0}'"));
	...
	Сообщения.Вставить("[СообщениеВызовРазрешитьРаботуПользователей]", НСтр("ru = 'СоединенияИБ.РазрешитьРаботуПользователей()';
																			|en = 'IBConnections.AllowUserAuthorization()'"));
	Сообщения.Вставить("[СообщениеОтказВызоваРазрешитьРаботуПользователей]", НСтр("ru = 'Исключение при вызове СоединенияИБ.РазрешитьРаботуПользователей: {0}, {1}';
																					|en = 'Exception when calling IBConnections.AllowUserAuthorization: {0}, {1}'"));
	...
	Сообщения.Вставить("[СообщениеОтказВызоваОбновитьИсправленияИзСкрипта]", НСтр("ru = 'Исключение при вызове ОбновлениеКонфигурацииВызовСервера.ОбновитьИсправленияИзСкрипта: {0}, {1}';
																					|en = 'Exception when calling ConfigurationUpdateServerCall.UpdatePatchesFromScript: {0}, {1}'"));
	Сообщения.Вставить("[СообщениеВызовВыполнитьОбновлениеИнформационнойБазы]", НСтр("ru = 'ОбновлениеИнформационнойБазыВызовСервера.ВыполнитьОбновлениеИнформационнойБазы({0})';
																					|en = 'InfobaseUpdateServerCall.UpdateInfobase({0})'"));
	Сообщения.Вставить("[СообщениеОтказВызоваВыполнитьОбновлениеИнформационнойБазы]", НСтр("ru = 'Исключение при вызове ОбновлениеИнформационнойБазыВызовСервера.ВыполнитьОбновлениеИнформационнойБазы: {0}, {1}.';
																							|en = 'Exception when calling InfobaseUpdateServerCall.UpdateInfobase: {0}, {1}.'"));
	...
	Сообщения.Вставить("[СообщениеОтменаБлокировкиРаботыПользователей]", НСтр("ru = 'Исключение при вызове doDisconnectAndBlockUsers: {0}, {1}';
																				|en = 'Exception when calling doDisconnectAndBlockUsers: {0}, {1}'"));
	...
	Сообщения.Вставить("[СообщениеВызовВыполнитьОтложенноеОбновлениеСейчас]", НСтр("ru = 'ОбновлениеИнформационнойБазыСлужебный.ВыполнитьОтложенноеОбновлениеСейчас()';
																					|en = 'InfobaseUpdateInternal.ExecuteDeferredUpdateNow()'"));
	Сообщения.Вставить("[СообщениеОтказВызоваВыполнитьОтложенноеОбновлениеСейчас]", НСтр("ru = 'Исключение при вызове ОбновлениеИнформационнойБазыСлужебный.ВыполнитьОтложенноеОбновлениеСейчас: {0}, {1}.';
																						|en = 'Exception when calling InfobaseUpdateInternal.ExecuteDeferredUpdateNow: {0}, {1}.'"));
	Сообщения.Вставить("[СообщениеОтказВызоваУдалитьИсправленияИзСкрипта]", НСтр("ru = 'Исключение при вызове ОбновлениеКонфигурацииВызовСервера.УдалитьИсправленияИзСкрипта: {0}, {1}.';
																				|en = 'Exception when calling ConfigurationUpdateServerCall.DeletePatchesFromScript: {0}, {1}.'"));
	...
	Сообщения.Вставить("[СообщениеЗавершениеОбновления]", НСтр("ru = 'Завершение';
																|en = 'Completing'"));
	Сообщения.Вставить("[СообщениеОтказИнициализации]", НСтр("ru = ': Ошибка инициализации переменных:';
															|en = ': Variable initialization error:'") + Символы.НПП);
	...
	Сообщения.Вставить("[СообщениеОтказСозданияОбъектаCOMСоединителя]", НСтр("ru = ': Ошибка создания объекта COM-соединителя:';
																			|en = ': An error occurred while creating a COM connector object:'") + Символы.НПП);
	Сообщения.Вставить("[СообщениеУстановкаСоединенияСБазой]", НСтр("ru = ': Установка соединения с';
																	|en = ': Establishing a connection with'") + Символы.НПП);
	Сообщения.Вставить("[СообщениеОтказСоединенияСБазойОбщее]", НСтр("ru = ': Ошибка установки соединения с';
																	|en = ': An error occurred while establishing a connection with'") + Символы.НПП);
	...
	Сообщения.Вставить("[СообщениеВызовУдалитьИсправленияИзСкрипта]", НСтр("ru = ': Вызов ОбновлениеКонфигурацииВызовСервера.УдалитьИсправленияИзСкрипта()...';
																			|en = ': Calling ConfigurationUpdateServerCall.DeletePatchesFromScript()...'"));
	Сообщения.Вставить("[СообщениеВызовОбновитьИсправленияИзСкрипта]", НСтр("ru = ': Вызов ОбновлениеКонфигурацииВызовСервера.ОбновитьИсправленияИзСкрипта()...';
																			|en = ': Calling ConfigurationUpdateServerCall.UpdatePatchesFromScript()...'"));
	Сообщения.Вставить("[СообщениеОшибкаБСП]", НСтр("ru = ': Ошибка БСП:';
													|en = ': SSL error:'") + Символы.НПП);
