...
Процедура ВыполнитьОбменСФСС() Экспорт
	...
	Для каждого Организация Из Организации Цикл
		...
		Если НЕ Результат.Выполнено Тогда
			Шаблон = НСтр("ru = 'При получении данных СЭДО ФСС по организации %1 произошла ошибка: %2.';
							|en = 'При получении данных СЭДО ФСС по организации %1 произошла ошибка: %2.'");
	...
	Если БылиОшибки Тогда
		ОписаниеОшибки = НСтр("ru = 'При получении данных СЭДО ФСС происходили ошибки. Подробную информацию об ошибках см. в технологическом журнале.';
								|en = 'При получении данных СЭДО ФСС происходили ошибки. Подробную информацию об ошибках см. в технологическом журнале.'");
	...
	Если ДанныеСообщения.Тип = ТипСообщенияОшибкиЛогическогоКонтроля Тогда
		...
		Если НЕ ДанныеОшибки.ИсходноеСообщениеНайдено Тогда
			...
			РезультатОбработки.ОписаниеОшибки = НСтр("ru = 'Не найдены данные исходного сообщения:';
													|en = 'Не найдены данные исходного сообщения:'") + Символы.ПС
...
Функция СобытиеЖурналаРегистрации()
	...
	Возврат НСтр("ru = 'Автоматический обмен с СЭДО ФСС';
				|en = 'Автоматический обмен с СЭДО ФСС'");
