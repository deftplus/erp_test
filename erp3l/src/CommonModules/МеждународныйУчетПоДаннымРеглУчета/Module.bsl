...
Функция ПроверитьПравилаОтражения(МенеджерВременныхТаблиц, ПараметрыПроверки) Экспорт
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	СоответствияОборотов.НастройкаФормированияПроводок,
	|	СоответствияОборотов.Ссылка КАК Ссылка,
	|	СоответствияОборотов.СчетРеглУчетаДт,
	|	СоответствияОборотов.СчетРеглУчетаКт,
	|	СоответствияОборотов.УстановленДополнительныйОтбор
	...
	|		ПО СоответствияОборотов.НастройкаФормированияПроводок = ОборотыДокументовКОтражениюВУчете.НастройкаФормированияПроводок
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗЛИЧНЫЕ
	|	СоответствияСчетов.НастройкаФормированияПроводок,
	|	СоответствияСчетов.Ссылка КАК Ссылка,
	|	СоответствияСчетов.СчетРеглУчета,
	|	СоответствияСчетов.УстановленДополнительныйОтбор
	...
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ОборотыДокументовКОтражениюВУчете КАК ОборотыДокументовКОтражениюВУчете
	|		ПО СоответствияСчетов.НастройкаФормированияПроводок = ОборотыДокументовКОтражениюВУчете.НастройкаФормированияПроводок
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ОборотыДокументовКОтражениюВУчете.ПланСчетов,
	|	ОборотыДокументовКОтражениюВУчете.НастройкаФормированияПроводок,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	УникальныеСоответствияОборотов.НастройкаФормированияПроводок,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	УникальныеСоответствияСчетов.НастройкаФормированияПроводок,
	...
	Отбор = Новый Структура("Счет, ПланСчетов, НастройкаФормированияПроводок");
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Выявление отклонений оборотов международного финансового учета
		...
		|turnovers and local accounting turnovers.'");
...
Процедура ТранслироватьПроводкиПоСоответствиямСчетов(ПроводкиРеглУчета, ТаблицаПроводок, ПараметрыФормированияПроводок)
	...
	Если ПроводкиРеглУчета.Количество() Тогда
		...
		Пока Выборка.Следующий() Цикл
			...
			Если УчетныеВалюты.УчетВФункциональнойВалюте = Перечисления.ВидыУчетаВФункциональнойВалюте.ВВалютеУпр И Выборка.СуммаУУ <> 0 Тогда
				РесурсыЗаполнены = Истина;
			ИначеЕсли УчетныеВалюты.УчетВФункциональнойВалюте = Перечисления.ВидыУчетаВФункциональнойВалюте.ВВалютеРегл И Выборка.Сумма <> 0 Тогда
				РесурсыЗаполнены = Истина;
...
Функция ПрименитьСоответствияСчетов(ТаблицаОборотов, ВыборкаСоответствияСчетов)
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	ТаблицаОборотов.ПланСчетов,
	|	ТаблицаОборотов.НастройкаФормированияПроводок,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ТаблицаОборотов.ПланСчетов КАК ПланСчетов,
	|	ТаблицаОборотов.НастройкаФормированияПроводок КАК НастройкаФормированияПроводок,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ТаблицаСчетов.ПланСчетов,
	|	ТаблицаСчетов.НастройкаФормированияПроводок,
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.СчетаРеглУчетаИгнорируемыеПриОтраженииВМеждународномУчете КАК ИгнорируемыеСчета
	|		ПО ТаблицаСчетов.НастройкаФормированияПроводок = ИгнорируемыеСчета.НастройкаФормированияПроводок
