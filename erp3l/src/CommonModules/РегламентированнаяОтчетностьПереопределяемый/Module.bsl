...
Функция ПолучитьСведенияОПоказателяхОтчета(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета = Неопределено) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетПрибыль" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2015Кв1" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2016Кв4"
			ИЛИ ИДРедакцииОтчета = "ФормаОтчета2019Кв4" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2020Кв4"
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетИмущество" Тогда
		...
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2019Кв1" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2019Кв4" Или ИДРедакцииОтчета = "ФормаОтчета2020Кв4"
			Или ИДРедакцииОтчета = "ФормаОтчета2020Кв4_1" Или ИДРедакцииОтчета = "ФормаОтчета2021Кв4" Тогда
			
			РегламентированнаяОтчетностьУП.ПолучитьСведенияОПоказателяхОтчетаИмуществоФормаОтчета2019_2021(ПоказателиОтчета, ИДРедакцииОтчета);
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтрановойОтчет" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьУХ");
...
Процедура ЗаполнитьОтчет(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетПрибыль" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2015Кв1" ИЛИ ИДРедакцииОтчета = "ФормаОтчета2016Кв4"
			...
			Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияКИК") Тогда
				...
				Параметры.Добавить(ПараметрыОтчета);
				Параметры.Добавить(Контейнер);
				Параметры.Добавить(ТаблицаРасшифровки);
				Параметры.Добавить(ИДРедакцииОтчета);
				ОбщегоНазначения.ВыполнитьМетодКонфигурации("РегламентированнаяОтчетностьУХ.ЗаполнитьРегламентированныйОтчетНалогНаПрибыль", Параметры);
			КонецЕсли;
			#КонецОбласти
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчет3НДФЛ" Тогда
		...
		Если ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияКИК") Тогда
			...
			Параметры.Добавить(ТаблицаРасшифровки);
			Параметры.Добавить(ИДРедакцииОтчета);
			ОбщегоНазначения.ВыполнитьМетодКонфигурации("РегламентированнаяОтчетностьУХ.ЗаполнитьРегламентированныйОтчет3НДФЛ", Параметры);
		КонецЕсли;
	#КонецОбласти
	#Область УХ_Встраивание_МСО
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтрановойОтчет" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
	...
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеМатрицаРисковКП" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьУХ");
		МодульУХ.ЗаполнитьМатрицуРисковКП(ПараметрыОтчета, Контейнер);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеРезультатыВыполнения" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьУХ");
		МодульУХ.ЗаполнитьРезультатыВыполнения(ПараметрыОтчета, Контейнер);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеРискиОрганизацииНалоговыйМониторинг" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьУХ");
		МодульУХ.ЗаполнитьРискиОрганизацииНалоговыйМониторинг(ПараметрыОтчета, Контейнер);
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеКонтрольныеПроцедуры" И ОбщегоНазначения.ПодсистемаСуществует("ПодсистемыУХ.ИнтеграцияМежстрановаяОтчетность") Тогда
		МодульУХ = ОбщегоНазначения.ОбщийМодуль("РегламентированнаяОтчетностьУХ");
