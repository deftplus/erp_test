...
// Возвращаемое значение:
// 	Неопределено, РегистрСведенийКлючЗаписиИмяРегистраСведений - ключ записи.
...
// Параметры:
// 	ИмяРегистра - Строка - наименование периодического регистра сведений.
// 	КлючЗаписи - РегистрСведенийКлючЗаписиИмяРегистраСведений - ключ записи регистра.
...
// Возвращаемое значение:
// 	РегистрСведенийКлючЗаписиИмяРегистраСведений - менеджер записи регистра сведений.
...
// 	КлючЗаписи - РегистрСведенийКлючЗаписиИмяРегистраСведений - ключ записи регистра сведений.
...
//
// Возвращаемое значение:
//	ПеречислениеСсылка.ПорядокУчетаВНА - Порядок начисления амортизации в бухгалтерском учет.
//
