...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ЗаказНаРемонт", "Дата", "УправлениеРемонтами", "Организация");
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Какой статус?
									 ...
									 |See what R&M types were carried out and when.
...
Процедура ДобавитьПрофильЭксплуатационник(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Описание = НСтр(
		...
		|2. Registration of the assets operating time'");
