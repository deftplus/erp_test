		...
		Для Каждого ИдентификаторСистемы Из ИдентификаторыСистем Цикл
			...
			Если НайденныеСтроки.Количество() = 0 Тогда
				...
				Результат.СообщениеОбОшибке  = НСтр("ru = 'Не удалось получить информацию о внешней системе.
					...
					|en = 'Cannot get the information about the external system.
				...
				Результат.ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
					НСтр("ru = 'Идентификатор внешней системы %1 не обнаружен в сервисе.';
						|en = 'An ID of the %1 external system is not found in the service.'"),
...
Функция ИнформацияОВнешнихСистемах()
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало получения информации о доступных внешних системах.';
			|en = 'Start getting the information about available external systems.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось получить информацию о доступных внешних системах.
					...
					|%4';
					|en = 'Failed to get information about available external systems.
					|
					|%1
					|
					|Technical information about the error:
					| When getting information about available external systems, the service returned an error.
					|URL: %2
					|Error code: %3
...
Процедура ПрочитатьДанные_sourcesgetAvailableList(
	...
	ТекстЖурналРегистрации = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
		НСтр("ru = 'Получен ответ сервиса обмена данными с внешними системами:
			|%1';
			|en = 'The service response for data exchange with external systems is received:
			|%1'"),
		ТелоJSON);
...
Функция ИдентификаторОбменДанными(ИдентификаторСистемы, ОписаниеНастройки) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало получения идентификатора загрузки данных.';
			|en = 'Start getting a data import ID.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось получить идентификатор обмена данными.
					...
					|Подробная информация:
					|%4';
					|en = 'Failed to get data exchange ID.
					|
					|%1
					|
					|Technical information about the error:
					| When getting data exchange ID the service returned an error.
					|URL: %2
					|Error code: %3
					|Detailed information:
					|%4'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено получение идентификатора обмена данными.';
			|en = 'Data exchange ID is received.'"),
		Ложь);
...
Функция ИнформацияОНастроенныхОбменахДанными() Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало получения информации о настроенных обменах данными.';
			|en = 'Start getting information about set data exchanges.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось получить информацию о настроенных обменах данными.
				...
				|Подробная информация:
				|%4';
				|en = 'Failed to get information about set up data exchanges.
				|
				|%1
				|
				|Technical information about the error:
				| When getting information about set up data exchanges the service returned an error.
				|URL: %2
				|Error code: %3
				|Detailed information:
				|%4'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено получение информации о настроенных обменах данными.';
			|en = 'Information about set data exchanges received.'"),
		Ложь);
...
Функция УдалитьИдентификаторОбменаДанными(ИдентификаторОбмена) Экспорт
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось удалить настройку обмена данными.
				...
				|Подробная информация:
				|%4';
				|en = 'Failed to remove data exchange setup.
				|
				|%1
				|
				|Technical information about the error:
				| When removing data exchange setup, the service returned an error.
				|URL: %2
				|Error code: %3
				|Detailed information:
				|%4'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено удаление настройки обмена данными.';
			|en = 'Data exchange setting is removed.'"),
		Ложь);
...
Функция ОбновитьОписаниеНастройки(ИдентификаторОбмена, ОписаниеНастройки) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало обновления описания настройки обмена данными.';
			|en = 'Start updating data exchange setting details.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось обновить описание настройки обмена данными.
				...
				|Подробная информация:
				|%4';
				|en = 'Failed to update details of data exchange setup.
				|
				|%1
				|
				|Technical information about the error:
				| When updating data exchange setup details, the service returned an error.
				|URL: %2
				|Error code: %3
				|Detailed information:
				|%4'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено обновление описание настройки обмена данными.';
			|en = 'Update of data exchange setting details is completed.'"),
		Ложь);
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Не удалось обновить настройки обмена данными.
				...
				|Подробная информация:
				|%4';
				|en = 'Failed to update data exchange settings.
				|
				|%1
				|
				|Technical information about the error:
				|When updating data exchange settings, the service returned an error.
				|URL: %2
				|Error code: %3
				|Detailed information:
				|%4'"),
...
Функция ОписаниеФайлаОбменаДанными(ИдентификаторОбмена) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Начало получения информации о файле обмена.';
			|en = 'Start getting the exchange file information.'"),
		Ложь);
		...
		Иначе
			...
			ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось получить описание файла обмена.
					...
					|Подробная информация:
					|%4';
					|en = 'Failed to get data exchange file details.
					|
					|%1
					|
					|Technical information about the error:
					| When getting information about data exchange file, the service returned an error.
					|URL: %2
					|Error code: %3
					|Detailed information:
					|%4'"),
...
Процедура ПрочитатьДанные_packagenext(
	...
	Если Прав(НРег(СокрЛП(СтруктураURI.Хост)), 6) <> Прав(НРег(СокрЛП(ХостСервиса)), 6) Тогда
		СообщениеОбОшибке = НСтр("ru = 'Неверный адрес файла обмена данными.';
								|en = 'Incorrect data exchange file address.'");
...
Функция ФайлОбменаДанными(ИдентификаторОбмена, ОписаниеФайлаОбмена) Экспорт
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Получение файла обмена данными: %1';
					|en = 'Getting data exchange file: %1'"),
		...
		Иначе
			...
			РезультатОперации.СообщениеОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Ошибка при получении файла обмена %1: 
					|%2';
					|en = 'An error occurred when getting the %1 exchange file: 
					|%2'"),
			...
			ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось получить файла обмена.
					...
					|Подробная информация:
					|%4';
					|en = 'Failed to get data exchange file.
					|
					|%1
					|
					|Technical information about the error:
					| When getting a data exchange file, the service returned an error.
					|URL: %2
					|Error code: %3
					|Detailed information:
					|%4'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершено получение файла обмена данными.';
			|en = 'Data exchange file is received.'"),
		Ложь);
...
Функция ПодтвердитьОбработкуФайлаОбменаДанными(ИдентификаторОбмена, ИдентификаторФайла) Экспорт
	...
	Если Не ПустаяСтрока(РезультатОтправки.КодОшибки) Тогда
		...
		ИнформацияОбОшибке = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = 'Не удалось отправить подтверждение загрузки файла обмена.
					...
					|Подробная информация:
					|%4';
					|en = 'Failed to send a confirmation of data exchange file import.
					|
					|%1
					|
					|Technical information about the error:
					| When sending a confirmation of data exchange file import, the service returned an error.
					|URL: %2
					|Error code: %3
					|Detailed information:
					|%4'"),
	...
	ЗаписатьИнформациюВЖурналРегистрации(
		НСтр("ru = 'Завершена отправка подтверждения о загрузке файла.';
			|en = 'Confirmation of the file import is sent.'"),
		Ложь);
...
Функция ПереопределитьСообщениеПользователю(КодОшибки)
	...
	ИначеЕсли КодОшибки = "НеверныйИдентификатор" Тогда
		Возврат НСтр("ru = 'Идентификатор обмена данными не найден на Портале 1С:ИТС.
			|Подробнее см. в журнале регистрации.';
			|en = 'The data exchange ID is not found on 1C:ITS Portal.
			|For more information, see the event log.'");
	...
	ИначеЕсли КодОшибки = "СервисВременноНеДоступен" Тогда
		Возврат НСтр("ru = 'Не удалось подключиться к сервису обмена данными с внешними системами.
			...
			|The service is temporarily unavailable. Try connecting later.'");
	ИначеЕсли КодОшибки = "ОшибкаСервиса" Тогда
		Возврат НСтр("ru = 'Ошибка работы с сервисом обмена данными с внешними системами.';
					|en = 'An error occurred when working with service for data exchange with external systems.'");
		...
		Если Результат.ДанныеАутентификации = Неопределено Тогда
			...
			Результат.ИнформацияОбОшибке =
				НСтр("ru = 'Для работы с сервисом обмена данными с внешними системами 
					...
					|en = 'You need
					| to connect the online user support to operate the service for the data exchange with external systems.'");
