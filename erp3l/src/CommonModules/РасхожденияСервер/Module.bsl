...
Процедура АктОРасхожденияхСписокОбработатьПараметрОснования(Форма, ЭтоАктыОРасхожденияПослеОтгрузки) Экспорт
	...
	ИначеЕсли Форма.ТипОснованияАктаОРасхождении = Перечисления.ТипыОснованияАктаОРасхождении.ПередачаТоваровХранителю Тогда
		...
		Форма.Заголовок = НСтр("ru = 'Акты о расхождениях после передачи товаров хранителю';
								|en = 'Discrepancy reports following goods transfer to bailee'");
...
//
Процедура СформироватьНадписьСпособаОтраженияРасхождений(Товары, НадписьРасхождения, НадписьОформитьДокументы, ТипАкта, ТипОперации = "") Экспорт
