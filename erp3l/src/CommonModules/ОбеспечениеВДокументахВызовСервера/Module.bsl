...
Функция ЗаданияПоЗаказамПоТипу(ПустаяСсылка) Экспорт
	Возврат ОбеспечениеВДокументахСервер.ЗаданияПоЗаказамПоТипу(ПустаяСсылка);
КонецФункции
...
Функция НужноОбновитьДоступностьПослеЗаписи(Заказы) Экспорт
	...
	Возврат ОбеспечениеВДокументахСервер.НужноОбновитьДоступностьПослеЗаписи(Заказы);
