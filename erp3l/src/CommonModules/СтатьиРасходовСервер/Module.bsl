...
Процедура УправлениеЭлементамиФормы(Форма) Экспорт
	...
	Элементы.ПереключательИспользоватьПолныеВозможности.Видимость = НЕ Форма.БазоваяВерсия;
	...
	Иначе
		...
		Элементы.ПравилоРаспределенияРасходовНУПолные.Видимость = 
			Объект.ВариантРаспределенияРасходовНУ = Перечисления.ВариантыРаспределенияРасходов.НаРасходыБудущихПериодов;
		// Надписи
