...
//
Процедура ПодготовитьСписокНалоговыхОрганов(Субъекты, НачалоПериода, КонецПериода, СписокНалоговыхОрганов) Экспорт
	//++ НЕ УТ
	СписокНалоговыхОрганов = ЗаполнениеФинОтчетностиВБанкиУП.НалоговыеОрганы(Субъекты, НачалоПериода, КонецПериода);
	//-- НЕ УТ
КонецПроцедуры
