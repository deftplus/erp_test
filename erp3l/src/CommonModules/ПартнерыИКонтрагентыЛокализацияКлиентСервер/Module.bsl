...
Функция СтранаВеденияУчета() Экспорт
	...
	//++ Локализация
	СтранаВеденияУчета = ПредопределенноеЗначение("Справочник.СтраныМира.Россия");
	//-- Локализация
...
Процедура УправлениеДоступностьюКонтрагент(Форма) Экспорт
	...
	Иначе
		...
		Если Форма.Объект.ЮрФизЛицо = ПредопределенноеЗначение("Перечисление.ЮрФизЛицо.ЮрЛицоНеРезидент")
			И Форма.Объект.СтранаРегистрации = СтранаВеденияУчета() Тогда
...
Процедура УправлениеЭлементамиЮридическихРеквизитов(Форма) Экспорт
	...
	Если ПартнерыИКонтрагентыЛокализацияКлиентСервер.СтранаВеденияУчета() = ПредопределенноеЗначение("Справочник.СтраныМира.Россия") Тогда
