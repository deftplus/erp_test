...
Процедура ЗаписатьСформированныеДвижения(ПараметрыРасчета, ПротоколыРасчета) Экспорт
	...
	Если ПараметрыРасчета.ЗапущенРасчетПартий Тогда
		...
		ИмяРегистра2_4 = Метаданные.РегистрыСведений.ДетализацияСебестоимостиТоваров.Имя;
		...
		Если (ПараметрыРасчета.Движения.Свойство(ИмяРегистра)
		 ...
		 ИЛИ (ПараметрыРасчета.Движения.Свойство(ИмяРегистра2_4)
		 	И ПараметрыРасчета.Движения[ИмяРегистра2_4].ЕстьИзмененныеДанные)
		 ИЛИ (ПараметрыРасчета.Движения.Свойство(ИмяРегистра2_4Постатейные)
		 	И ПараметрыРасчета.Движения[ИмяРегистра2_4Постатейные].ЕстьИзмененныеДанные) Тогда
...
Функция ЭтоЛокализуемыйРегистрСведений(ИмяРегистра) Экспорт
	...
	//++ Локализация
	Если ИмяРегистра = Метаданные.РегистрыСведений.ДетализацияСебестоимостиТоваров.Имя
	 ИЛИ ИмяРегистра = Метаданные.РегистрыСведений.ДетализацияСебестоимостиТоваровПостатейныеЗатраты.Имя
	 ИЛИ ИмяРегистра = Метаданные.РегистрыСведений.ДетализацияСебестоимостиТоваровПостатейныеЗатратыНЗП.Имя Тогда
		Возврат Истина;
	КонецЕсли;
	//-- Локализация
	Возврат Ложь;
