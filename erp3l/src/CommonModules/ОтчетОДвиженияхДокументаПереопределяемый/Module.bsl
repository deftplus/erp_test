...
Процедура ПриОпределенииРегистровСДвижениями(Документ, РегистрыСДвижениями) Экспорт
	...
	ПлатежныеПозицииВстраиваниеУХПереопределяемый.ДополнитьСоответствияРегистраторовОтчетаОДвижениях(Документ, РегистрыСДвижениями);
	РегистрацияДанныхБюджетирования.ДополнитьСоответствияРегистраторовОтчетаОДвижениях(Документ, РегистрыСДвижениями);
	УправлениеЗакупкамиВстраиваниеПереопределяемыйУХ.ДополнитьСоответствияРегистраторовОтчетаОДвижениях(
		Документ, РегистрыСДвижениями);
	#КонецОбласти 
КонецПроцедуры
