...
Функция ТекстЗапросаТаблицаОтражениеДокументовВРеглУчете(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ВЫБРАТЬ
	|		ТабличнаяЧасть.Ссылка КАК Ссылка,
	|		НАЧАЛОПЕРИОДА(ТабличнаяЧасть.ДатаОперации, ДЕНЬ)
	|	ИЗ
	...
	|	ВЫБРАТЬ
	|		ТабличнаяЧасть.Ссылка КАК Ссылка,
	|		НАЧАЛОПЕРИОДА(ТабличнаяЧасть.ДатаПроизводства, ДЕНЬ)
	|	ИЗ
	...
	|	ВЫБРАТЬ
	|		ТабличнаяЧасть.Ссылка КАК Ссылка,
	|		НАЧАЛОПЕРИОДА(ТабличнаяЧасть.ДатаОтгрузки, ДЕНЬ)
	|	ИЗ
	...
	|	ВЫБРАТЬ
	|		ТабличнаяЧасть.Ссылка КАК Ссылка,
	|		НАЧАЛОПЕРИОДА(ТабличнаяЧасть.ДатаРасхода, ДЕНЬ)
	|	ИЗ
