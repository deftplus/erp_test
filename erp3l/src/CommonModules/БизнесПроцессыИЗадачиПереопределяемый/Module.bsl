...
Процедура ПриНачальномЗаполненииРолейИсполнителей(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий заявки на возврат товаров от клиентов';
		|en = 'Approver of requests for goods return from customers'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий коммерческие условия закупок';
		|en = 'Approver purchase commercial terms'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий коммерческие условия продаж';
		|en = 'Approver sales commercial terms'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий логистические условия закупок';
		|en = 'Approver purchase logistics terms'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий логистические условия продаж';
		|en = 'Approver sales logistics terms'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий установки цен номенклатуры';
		|en = 'Approver product pricing'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий финансовые условия закупок';
		|en = 'Approver purchase financial terms'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий финансовые условия продаж';
		|en = 'Approver sales financial terms'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий ценовые условия закупок';
		|en = 'Approver purchase price terms'", КодыЯзыков); // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий ценовые условия продаж';
		|en = 'Approver sales price terms'", КодыЯзыков); // @НСтр
