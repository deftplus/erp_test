...
//
// Параметры:
//	ПриемникЗначения - УсловноеОформлениеКомпоновкиДанных, ВариантыПользовательскогоПоляВыборКомпоновкиДанных, ОформляемыеПоляКомпоновкиДанных, ЗначенияПараметровДанныхКомпоновкиДанных - коллекция элементов КД, куда копируются параметры
//	ИсточникЗначения - УсловноеОформлениеКомпоновкиДанных, ВариантыПользовательскогоПоляВыборКомпоновкиДанных, ОформляемыеПоляКомпоновкиДанных, ЗначенияПараметровДанныхКомпоновкиДанных - коллекция элементов КД, откуда копируются параметры
...
//
// Параметры:
//	КоллекцияОформляемыхПолей 	- УсловноеОформлениеКомпоновкиДанных - коллекция оформляемых полей КД
