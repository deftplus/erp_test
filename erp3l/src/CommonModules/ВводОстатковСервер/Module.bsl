...
Функция ОписаниеХозяйственныхОперацийВводаОстатковВНА(УчитыватьФО)
	...
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков переданных в аренду основных средств %1';
																	|en = 'Enter opening balance of leased out %1 fixed assets'");
	...
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков арендованных основных средств (за балансом) %1';
																	|en = 'Entering the opening balances of leased fixed assets (off-balance) %1'");
	...
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков взаиморасчетов по договорам аренды %1';
																	|en = 'OB entry: AR/AP under lease contracts %1'");
	...
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков арендованных основных средств (на балансе) %1';
																	|en = 'Entering the opening balances of leased fixed assets (on balance sheet) %1'");
	...
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков переданных в аренду предметов лизинга на балансе %1';
																	|en = 'OB entry: assets provided to leasee (on balance sheet) %1'");
