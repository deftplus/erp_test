...
Функция ПолучитьИнформационнуюСтрокуДляЯчейки(Элементы,
	...
	Если ПозицияПодстроки <> 0 Тогда
		...
		Если ЗначениеЗаполнено(ТекущееМаркетинговоеМероприятие) Тогда
			ФорматированнаяСтрокаМаркетинговоеМероприятие = Новый ФорматированнаяСтрока(НСтр("ru = 'по акции';
																							|en = 'by promotion'"),Новый Шрифт(,,Истина),WebЦвета.Коралловый,,ПолучитьНавигационнуюСсылку(ТекущееМаркетинговоеМероприятие));
