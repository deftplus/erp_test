	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Объект метаданных %1 не может быть обработан обработчиком
				...
				|en = 'Metadata object %1 cannot be processed by
				| ExportImportExchangePlanNodes.BeforeExportObject() handler'", Метаданные.ОсновнойЯзык.КодЯзыка),
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(
			НСтр("ru = 'Объект метаданных %1 не может быть обработан обработчиком
                  ...
                  |en = 'Metadata object %1 cannot be processed by
                  |ExportImportExchangePlanNodes.BeforeImportObject() handler'", Метаданные.ОсновнойЯзык.КодЯзыка),
