...
Процедура ОбработкаРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	УправлениеРискамиКлиент.ОбработкаРасшифровкиДиаграммаРисков(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка);//В БМ тоже передаются клиентски модули, но код из них не выполняется
