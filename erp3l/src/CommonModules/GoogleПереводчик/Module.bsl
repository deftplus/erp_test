...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	Настройки.ИнструкцияПоПодключению = СтроковыеФункции.ФорматированнаяСтрока(НСтр(
		...
		|en = 'How to setup:
		|1. Activate a billing account in <a href = ""https://console.cloud.google.com/billing"">Google Cloud</a>.
		|2. On the <a href = ""https://console.cloud.google.com/apis/credentials"">API Credentials</a> page, click <b>Create credentials</b> and select <b>API key</b>.
