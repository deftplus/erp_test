...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|				ГДЕ Т.Ссылка = &Ссылка)) КАК ПорядокУчетаОС
	|		ПО Строки.ОсновноеСредство = ПорядокУчетаОС.ОсновноеСредство
	|	
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрБухгалтерии.Хозрасчетный.Остатки(
	|			&Дата,
	|			Счет В 
	|				(ВЫБРАТЬ ПорядокУчетаОС.СчетЗабалансовогоУчета
	|				ИЗ 
	...
	|				(ВЫБРАТЬ
	|					ТабличнаяЧастьОС.Ссылка.Организация, ТабличнаяЧастьОС.Ссылка.Подразделение, ТабличнаяЧастьОС.Ссылка.Контрагент, ТабличнаяЧастьОС.ОсновноеСредство
	|				ИЗ
	...
	|			И ПорядокУчетаОС.СчетЗабалансовогоУчета = ОстаткиПоСчетуУчета.Счет
	|
