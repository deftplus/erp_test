...
Функция СтруктураПомещений(СведенияОбАдресе) Экспорт
	...
	Для Каждого Помещение Из МассивПомещений Цикл
		...
		Если СтрСравнить(ТипПомещения, "А/я") = 0 Или СтрСравнить(ТипПомещения, "А\я") = 0 Тогда
			ТипПомещения = "АЯ";
		ИначеЕсли СтрСравнить(ТипПомещения, "П/о") = 0 Или СтрСравнить(ТипПомещения, "П\о") = 0 Тогда
			ТипПомещения = "ПО";
		ИначеЕсли СтрСравнить(ТипПомещения, "В/ч") = 0 Или СтрСравнить(ТипПомещения, "В\ч") = 0 Тогда
			ТипПомещения = "ВЧ";
		ИначеЕсли Не Помещения.Свойство(ТипПомещения) Тогда
