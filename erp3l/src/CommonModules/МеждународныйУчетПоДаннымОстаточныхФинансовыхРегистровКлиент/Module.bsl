...
// Открывает отчет "Анализ корреспонденций оперативного учета" с настройкой для показа ошибок двойной записи в финансовых регистрах
//
// Параметры:
//	ПараметрыОтчета - Структура - параметры расшифровки:
...
//
Процедура АнализОшибокКорреспонденций(ПараметрыОтчета) Экспорт
	
	ПараметрыФормы = Новый Структура;
	ПараметрыФормы.Вставить("КлючВарианта", "ОшибкиКорреспонденций");
	...
	ЗначенияПользовательскихНастроек.Вставить("ПериодОтчета", Новый СтандартныйПериод(НачалоМесяца(ПараметрыОтчета.Период), КонецМесяца(ПараметрыОтчета.Период)));
	ЗначенияПользовательскихНастроек.Вставить("Организация", ПараметрыОтчета.МассивОрганизаций);
	ПользовательскиеНастройки = 
		МеждународныйУчетПоДаннымОстаточныхФинансовыхРегистровВызовСервера.ПользовательскиеНастройкиОтчетаАнализКорреспонденций(ЗначенияПользовательскихНастроек);
	ПараметрыФормы.Вставить("ПользовательскиеНастройки", ПользовательскиеНастройки);
	
	ОткрытьФорму("Отчет.АнализКорреспонденцийОперативногоУчета.ФормаОбъекта", ПараметрыФормы);
...
Процедура ОбработкаРасшифровки(ЭтаФорма, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	Если ПолноеИмяОтчета = "Отчет.АнализКорреспонденцийОперативногоУчета" Тогда
		Если КлючТекущегоВарианта = "АнализКорреспонденцийШахматка" Тогда
