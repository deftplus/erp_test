...
Функция СоответствуетУсловиям(ДобавляемыеДанные, СтруктураПараметров)
	...
	Если СтруктураПараметров.ТолькоРаботы
		...
		ТекстСообщения = НСтр("ru = 'Номенклатура ""%НазваниеУслуги%"" не является работой. В данную табличную часть разрешено добавлять только работы.';
								|en = 'The ""%НазваниеУслуги%"" item is not a work. You can add only works to this table.'");
