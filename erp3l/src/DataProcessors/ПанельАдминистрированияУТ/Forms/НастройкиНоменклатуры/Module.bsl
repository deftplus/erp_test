...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	НаборыПодсказка = НСтр("ru = 'Возможность объединения номенклатурных позиций в комплекты с целью удобного подбора комплектующих в ресурсные спецификации, документы продажи, назначения общей цены на комплект и вывода в печатных формах комплекта и комплектующих. Для настройки необходимо включить ""Множество видов номенклатуры"".';
							|en = 'Combine product items into sets to easily pick components to bills of materials, sales documents, put a common price for a set, and display set and components in print forms. To enable the option, select ""Multiple kinds of products"".'");
