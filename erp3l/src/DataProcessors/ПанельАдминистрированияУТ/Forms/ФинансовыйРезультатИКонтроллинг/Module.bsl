...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РеквизитПутьКДанным = "НаборКонстант.ИспользоватьУчетПрочихДоходовРасходов" ИЛИ РеквизитПутьКДанным = "" Тогда
		...
		Элементы.ФормироватьРезервыПредстоящихРасходов.Доступность = НаборКонстант.ИспользоватьУчетПрочихДоходовРасходов
			И НаборКонстант.ИспользоватьРеглУчет И ПартионныйУчетВерсии22;
	...
	Если РеквизитПутьКДанным = "" Тогда
		...
		СинхронизацияДанных = Константы.ИспользоватьСинхронизациюДанных.Получить();
		НоваяАрхитектураВзаиморасчетов = Константы.НоваяАрхитектураВзаиморасчетов.Получить();
		Элементы.ИспользоватьИсправлениеДокументов.Доступность = НоваяАрхитектураВзаиморасчетов И НЕ СинхронизацияДанных;
