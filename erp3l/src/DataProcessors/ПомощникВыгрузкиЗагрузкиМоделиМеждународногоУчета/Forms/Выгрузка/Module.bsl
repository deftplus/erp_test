...
&НаКлиенте
Процедура Подключаемый_СтраницаПриветствиеПриОткрытии(Отказ, ПропуститьСтраницу, Знач ЭтоПереходДалее)
	Элементы.КомандаДалее.КнопкаПоУмолчанию = Истина;
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_СтраницаПриветствиеПриПереходеДалее(Отказ)
...
&НаКлиенте
Процедура Подключаемый_СтраницаЗавершениеПриОткрытии(Отказ, ПропуститьСтраницу, Знач ЭтоПереходДалее)
...
&НаКлиенте
Процедура Подключаемый_СтраницаОжиданияПриОткрытии(Отказ, ПропуститьСтраницу, Знач ЭтоПереходДалее)
...
&НаКлиенте
Процедура Подключаемый_СтраницаОжиданияПослеОткрытия()
...
Процедура ЗаписатьРезультат()
	...
	Если СтатусВыполненнойЗагрузки Тогда
		ФайлВыгрузки = РезультатВыгрузкиИзФайла.ФайлВыгрузки; // ТекстовыйДокумент - 
