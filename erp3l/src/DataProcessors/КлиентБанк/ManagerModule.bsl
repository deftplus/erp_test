	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Выгрузка платежей в банк. Удаление временного файла';
				|en = 'Payment export to the bank. Temporary file deletion'", ОбщегоНазначения.КодОсновногоЯзыка()),
		...
		Исключение
			...
			ТекстСообщения  = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				НСтр("ru = '%1%2. Произошли ошибки при записи документа!';
					|en = '%1%2. Errors occurred when saving the document.'"),
			...
			ЗаписьЖурналаРегистрации(Событие,
				...
				СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ТекстОшибки,
					...
					?(ЭтоНовыйДокумент, ТекстСообщения, НСтр("ru = 'Произошли ошибки при записи документа!';
															|en = 'Errors occurred when saving the document.'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()))));
