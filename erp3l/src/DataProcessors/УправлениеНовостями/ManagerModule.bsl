	...
	Если ЗаписыватьВЖурналРегистрации = Истина Тогда
		...
		ОбработкаНовостей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Загрузка новостей. Загрузка файлов новостей';
				|en = 'News. Import news. Import news files'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
			?(КодРезультата > 0,
	...
	Если ЗаписыватьВЖурналРегистрации = Истина Тогда
		...
		ОбработкаНовостей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Загрузка новостей. Парсинг файлов новостей';
				|en = 'News. Import news. News file parsing'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
			?(КодРезультата > 0,
				УровеньЖурналаРегистрации.Ошибка,
				УровеньЖурналаРегистрации.Информация), // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
	...
	Если ЗаписыватьВЖурналРегистрации = Истина Тогда
		...
		ОбработкаНовостей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Загрузка классификаторов. Список обновлений классификаторов';
				|en = 'News. Import classifiers. Classifiers update list'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
			?(КодРезультата > 0,
				УровеньЖурналаРегистрации.Ошибка,
				УровеньЖурналаРегистрации.Информация), // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
				...
				Иначе
					ЛогШаговВыполнения.Добавить(
						НСтр("ru = 'Обработка.УправлениеНовостями.ПарсингХМЛФайлаНовостей(rss): Отключена работа с новостями через интернет.
							...
							|en = 'Обработка.УправлениеНовостями.ПарсингХМЛФайлаНовостей(rss): Work with news via the Internet is disabled.
			...
			Иначе
				ЛогШаговВыполнения.Добавить(
					НСтр("ru = 'Обработка.УправлениеНовостями.ПарсингХМЛФайлаНовостей(atom): Отключена работа с новостями через интернет.
						|Обновление классификаторов не выполнялось.';
						|en = 'Обработка.УправлениеНовостями.ПарсингХМЛФайлаНовостей(atom): Work with news via the Internet is disabled.
						|Classifiers were not updated.'"));
			КонецЕсли;
	...
	Если ЗаписыватьВЖурналРегистрации = Истина Тогда
		...
		ОбработкаНовостей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Загрузка новостей. Парсинг файлов новостей. Парсинг файла новостей';
				|en = 'News. News import. News file parsing. News file parsing '", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
			?(КодРезультата > 0,
				УровеньЖурналаРегистрации.Ошибка,
				УровеньЖурналаРегистрации.Информация), // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
	...
	Если ЗаписыватьВЖурналРегистрации = Истина Тогда
		...
		ОбработкаНовостей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Загрузка новостей. Загрузка новости';
				|en = 'News. Import news. Import news'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
			?(КодРезультата > 0,
				УровеньЖурналаРегистрации.Ошибка,
				УровеньЖурналаРегистрации.Информация), // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
	...
	Если ЗаписыватьВЖурналРегистрации = Истина Тогда
		...
		ОбработкаНовостей.ЗаписатьСообщениеВЖурналРегистрации(
			...
			НСтр("ru = 'Новости. Загрузка классификаторов. Соединение с веб-сервисом обновления стандартных списков';
				|en = 'News. Import classifiers. Connection with web service of standard list update'", ОбщегоНазначения.КодОсновногоЯзыка()), // ИдентификаторШага.
			?(КодРезультата > 0,
				УровеньЖурналаРегистрации.Ошибка,
				УровеньЖурналаРегистрации.Информация), // УровеньЖурналаРегистрации.*
			, // ОбъектМетаданных
