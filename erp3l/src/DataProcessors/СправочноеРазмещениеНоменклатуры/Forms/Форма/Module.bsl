...
// 
// Параметры:
//  ДокументПриемки - ДокументСсылка.СборкаТоваров, ДокументСсылка.ПриобретениеТоваровУслуг, ДокументСсылка.ВводОстатков, ДокументСсылка.ПрочееОприходованиеТоваров, ДокументСсылка.ПроизводствоБезЗаказа, ДокументСсылка.ПриходныйОрдерНаТовары, ДокументСсылка.ОрдерНаПеремещениеТоваров, ДокументСсылка.ПоступлениеТоваровОтХранителя, ДокументСсылка.ПересчетТоваров, ДокументСсылка.ПриемкаТоваровНаХранение, ДокументСсылка.ПоступлениеТоваровНаСклад, ДокументСсылка.АктОРасхожденияхПослеОтгрузки, ДокументСсылка.ПеремещениеТоваров, ДокументСсылка.ВозвратСырьяОтПереработчика, ДокументСсылка.ПоступлениеОтПереработчика, ДокументСсылка.ВозвратТоваровОтКлиента, ДокументСсылка.КорректировкаПриобретения, ДокументСсылка.ПоступлениеСырьяОтДавальца, ДокументСсылка.ЭтапПроизводства2_2, ДокументСсылка.АктОРасхожденияхПослеПеремещения, ДокументСсылка.КорректировкаРеализации, ДокументСсылка.РаспределениеВозвратныхОтходов, ДокументСсылка.ОприходованиеИзлишковТоваров, ДокументСсылка.АктОРасхожденияхПослеПриемки, ДокументСсылка.ОрдерНаОтражениеИзлишковТоваров, ДокументСсылка.ДвижениеПродукцииИМатериалов - Документ приемки
//  ДанныеДокумента - Структура - Данные документа:
// * ДокументБезТоваров - Булево -
// * РезультатПроверкиДокумента - РезультатЗапроса -
// * РезультатПоТабличнойЧасти - РезультатЗапроса -
// * РезультатПоШапкеДокумента - РезультатЗапроса -
// 
...
// Инициализировать места хранения.
// 
// Параметры:
//  ДокументПриемки - ДокументСсылка.СборкаТоваров, ДокументСсылка.ПриобретениеТоваровУслуг, ДокументСсылка.ВводОстатков, ДокументСсылка.ПрочееОприходованиеТоваров, ДокументСсылка.ПроизводствоБезЗаказа, ДокументСсылка.ПриходныйОрдерНаТовары, ДокументСсылка.ОрдерНаПеремещениеТоваров, ДокументСсылка.ПоступлениеТоваровОтХранителя, ДокументСсылка.ПересчетТоваров, ДокументСсылка.ПриемкаТоваровНаХранение, ДокументСсылка.ПоступлениеТоваровНаСклад, ДокументСсылка.АктОРасхожденияхПослеОтгрузки, ДокументСсылка.ПеремещениеТоваров, ДокументСсылка.ВозвратСырьяОтПереработчика, ДокументСсылка.ПоступлениеОтПереработчика, ДокументСсылка.ВозвратТоваровОтКлиента, ДокументСсылка.КорректировкаПриобретения, ДокументСсылка.ПоступлениеСырьяОтДавальца, ДокументСсылка.ЭтапПроизводства2_2, ДокументСсылка.АктОРасхожденияхПослеПеремещения, ДокументСсылка.КорректировкаРеализации, ДокументСсылка.РаспределениеВозвратныхОтходов, ДокументСсылка.ОприходованиеИзлишковТоваров, ДокументСсылка.АктОРасхожденияхПослеПриемки, ДокументСсылка.ОрдерНаОтражениеИзлишковТоваров, ДокументСсылка.ДвижениеПродукцииИМатериалов - Документ приемки
//  ДанныеДокумента - Структура - Данные документа:
