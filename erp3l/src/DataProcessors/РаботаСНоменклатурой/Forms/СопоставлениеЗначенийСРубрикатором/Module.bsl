...
Процедура СохранитьИзмененияСервер()
	...
	Исключение
		...
		ОбщегоНазначения.СообщитьПользователю(НСтр("ru = 'Ошибка записи сопоставления';
													|en = 'An error occurred when saving mapping'") + БизнесСетьКлиентСервер.ПодробностиВЖурналеРегистрации());
