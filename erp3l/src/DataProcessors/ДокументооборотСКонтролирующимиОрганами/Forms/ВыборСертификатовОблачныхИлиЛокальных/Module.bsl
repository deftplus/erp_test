...
Процедура ПоказатьСертификат()
	...
	Иначе
		...
		Если ТекДанные.ЭтоЭлектроннаяПодписьВМоделиСервиса Тогда
			СертификатДляПоказа.Вставить("ЭтоЭлектроннаяПодписьВМоделиСервиса", ТекДанные.ЭтоЭлектроннаяПодписьВМоделиСервиса);
