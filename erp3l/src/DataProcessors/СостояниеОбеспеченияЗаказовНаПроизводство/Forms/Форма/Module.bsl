...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтобранныеСостояния.Добавить(Перечисления.РаспределениеЗапасовСостояния.ОбеспеченКДате,
		НСтр("ru = 'Ожидается не в срок';
			|en = 'Expected not on time'"), Истина);
	...
	ОтобранныеСостояния.Добавить(Перечисления.РаспределениеЗапасовСостояния.ОтложитьОбеспечение,
		Перечисления.РаспределениеЗапасовСостояния.ОтложитьОбеспечение, Истина);
...
// Надпись "Резерв превышает остаток на складе" в поле "Состояние".
	...
	Элемент.Представление = НСтр("ru = 'Надпись ""Резерв превышает остаток на складе"" в поле ""Состояние""';
								|en = 'Label ""Reserve exceeds warehouse balance"" in the ""State"" field'");
	
	ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
	ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных("НаборСостояние");
	
	ОтборЭлемента = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	ОтборЭлемента.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Набор.РезервПревышаетОстатки");
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение = Истина;
	
	Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Резерв превышает остаток на складе';
																|en = 'Reserve exceeds warehouse balance'"));
...
Процедура УстановитьУсловноеОформлениеСписка(СписокУсловноеОформление, Префикс = "")
	...
	СписокДляОтбора.Добавить(Перечисления.РаспределениеЗапасовСостояния.Обеспечить);
	СписокДляОтбора.Добавить(Перечисления.РаспределениеЗапасовСостояния.ОтложитьОбеспечение);
	...
	Элемент.Представление = НСтр("ru = 'Надпись ""<не определена>"" в поле ""Дата поступления"", если не установлен основной способ обеспечения, не заполнен календарь или не установлена дата следующей поставки по графику';
								|en = 'The ""<not defined>"" label in the ""Date of receipt"" field, if the main supply method is not set, the calendar is not filled in or the date of the next scheduled delivery is not set'");
	...
	ОтборЭлемента.ПравоеЗначение = СписокДляОтбора;
	...
	Элемент.Представление = НСтр("ru = 'Подсветка даты поступления и заказа на поступления, если не установлен основной способ обеспечения, не заполнен календарь или не установлена дата следующей поставки по графику';
								|en = 'Highlighting the date of receipt and receipt order, if the main supply method is not set, the calendar is not filled in, or the date of the next scheduled delivery is not set'");
	...
	Элемент.Представление = НСтр("ru = 'Текст ""Поступило"" если состояние ""Обеспечен на складе"" или ""В резерве""';
								|en = 'The ""Received"" text if the status is ""Supplied at warehouse"" or ""In reserve""'");
	...
	Элемент.Представление = НСтр("ru = 'Надпись ""<способ обеспечения не задан>""';
								|en = 'Label ""<supply method is not set>""'");
...
&НаСервере
Функция УправлениеПараметрамиСписков()
...
Функция ТекстЗапроса()
	...
	ТекстЗапроса =
		"ВЫБРАТЬ РАЗРЕШЕННЫЕ
		|	СостояниеЗаказа.Состояние                                   КАК Состояние,
		...
		|	СостояниеЗаказа.Распределено + СостояниеЗаказа.НеОбеспечено КАК Количество,
		...
		|		И СостояниеЗаказа.Состояние В(&ВсеСостояния)";
