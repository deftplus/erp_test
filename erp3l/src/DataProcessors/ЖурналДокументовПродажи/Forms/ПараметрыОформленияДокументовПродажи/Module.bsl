...
Функция ПолучитьПараметры(Источник)
	...
	СтруктураПараметров.Вставить("УскоренныйРежим",                  Источник.УскоренныйРежим);
	//++ Локализация
...
Процедура УстановитьВидимостьДоступность(Форма)
	...
	//++ Локализация
	Форма.Элементы.СоздаватьСчетФактуру.Видимость = Истина;
	ОбработатьИзменениеФлага(
		Форма.СоздаватьДокументПродажи,
	...
	ЕстьПравоСоздаватьПКО = ЕстьПравоСоздаватьПКО();
	...
	Форма.Элементы.ГруппаФискализация.Видимость = Форма.ФискализацияДоступна;
	...
	Форма.Элементы.ГруппаУскоренныйРежим.Видимость = Форма.ПробиватьФискальныйЧек;
