		...
		Если ДанныеШтрихкода.Номенклатура <> Номенклатура Тогда
			ВывестиСообщениеНаСтраницеВводаКодаМаркировки(ЭтотОбъект,
				СтрШаблон(НСтр(
					...
					|en = 'Номенклатура отсканированного кода не соответствует: %1'"), ДанныеШтрихкода.Номенклатура));
			Возврат Ложь;
		КонецЕсли;
		...
		Если ХарактеристикаИспользуется И ДанныеШтрихкода.Характеристика <> Характеристика Тогда
			ВывестиСообщениеНаСтраницеВводаКодаМаркировки(ЭтотОбъект,
				СтрШаблон(НСтр(
					...
					|en = 'Характеристика отсканированного кода не соответствует: %1'"), ДанныеШтрихкода.Номенклатура));
			Возврат Ложь;
		КонецЕсли;
