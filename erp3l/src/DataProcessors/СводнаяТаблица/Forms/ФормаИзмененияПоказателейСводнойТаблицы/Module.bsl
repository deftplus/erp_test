...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Режим = "Актуализация" Тогда
		...
		АдресСтруктураФильтров  =  Параметры.АдресСтруктураФильтров;
		ТЗКолонокАдрес          =  Параметры.ТЗКолонокАдрес;
		тзДанныеАдрес           =  Параметры.тзДанныеАдрес;

		ДействияПриАктуализации = Перечисления.ДействияПриАктуализацииБюджетов.НеПереносить;
		Если ЗначениеЗаполнено(Параметры.АдресСтруктураФильтров) Тогда
			...
			Если СтруктураФильтров.Свойство("Фильтр_Сценарии") Тогда
				СценарийДляАктуализации = СтруктураФильтров.Фильтр_Сценарии.СценарийДляАктуализации;
				ТекущийСценарий         = СтруктураФильтров.Фильтр_Сценарии;
			КонецЕсли;	 
		КонецЕсли;
