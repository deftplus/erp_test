...
Процедура ПроверитьНаличиеНеиспользуемыхДвижений()
	...
	Если КоличествоДокументов = 0 Тогда
		...
		Элементы.ИнформационнаяНадпись.Заголовок = НСтр("ru = 'При отключеном учете себестоимости отсутствуют документы с движениями по регистрам учета себестоимости.';
														|en = 'When the cost accounting is off, there are no documents with movements by cost accounting registers.'");
	...
	|When the cost accounting is off, documents with movements by cost accounting registers are found: %2.
	|It may take some time to clear movements of this documents.'");
