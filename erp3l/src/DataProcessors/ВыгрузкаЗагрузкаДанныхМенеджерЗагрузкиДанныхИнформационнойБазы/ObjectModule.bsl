	...
	Для ИндексЗагружаемого = ИндексПервогоЗагружаемого По ТекущиеЗагружаемыеТипы.ВГраница() Цикл
		...
		Иначе
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'Выгрузка загрузка данных. Загрузка объекта пропущена';
					|en = 'Data Export and Import. Object import is skipped'", ОбщегоНазначения.КодОсновногоЯзыка()),
				...
				СтрШаблон(НСтр("ru = 'Загрузка данных объекта метаданных %1 пропущена, т.к. он включен в
                          ...
                          |the list of metadata objects to be excluded from data import and export procedures'", ОбщегоНазначения.КодОсновногоЯзыка()),
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'Выгрузка загрузка данных. Загрузка объекта метаданных.Ошибка';
						|en = 'Data Export and Import. Import the metadata object.Error'", ОбщегоНазначения.КодОсновногоЯзыка()),
