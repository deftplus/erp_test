...
Функция ТекстПоУмолчанию()
	...
	|en = 'Hello, &UserPresentation,
	|
	|We received a request to recover the password to &ConfigurationPresentation.
	|
	|Enter the code &VerificationCode to reset your password.
	|
	|If you did not request password recovery, please contact a technician.'");
