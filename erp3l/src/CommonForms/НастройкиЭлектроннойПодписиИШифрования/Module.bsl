...
Процедура ТехническаяИнформация(Команда)
	...
	ЭлектроннаяПодписьСлужебныйКлиент.СформироватьТехническуюИнформацию(
		НСтр("ru = 'Настройки электронной подписи и шифрования';
			|en = 'Настройки электронной подписи и шифрования'"));
	...
	Если Константы.ИспользоватьЭлектронныеПодписи.Получить() Тогда
		...
		ПодсказкаФлажка =
			НСтр("ru = 'Позволяет не устанавливать программу на компьютер пользователя
			           ...
			           |en = 'Allows you not to install the application on a user computer
			           ...
			           |or web server attached to the file infobase.'");
	...
	Если Не Константы.ИспользоватьЭлектронныеПодписи.Получить() Тогда
		...
		ПодсказкаФлажка =
			НСтр("ru = 'Позволяет не устанавливать программу и сертификат
			           ...
			           |on each computer which has 1C:Enterprise server
			           |or web server attached to the file infobase.'");
	ИначеЕсли Не Константы.ИспользоватьШифрование.Получить() Тогда
		...
		ПодсказкаФлажка =
			НСтр("ru = 'Позволяет не устанавливать программу и сертификат
			           ...
			           |должна быть установлена программа и сертификат с закрытым ключом.';
			           |en = 'Allows you not to install the application and certificate
			           |for signing on a user computer.
			           |
			           |Important: application and certificate with a private key must be installed
			           |on each computer which has 1C:Enterprise server
			           |or web server attached to the file infobase.'");
	Иначе
		...
		ПодсказкаФлажка =
			НСтр("ru = 'Позволяет не устанавливать программу и сертификат
			           ...
			           |должна быть установлена программа и сертификат с закрытым ключом.';
			           |en = 'Allows you not to install the application and certificate
			           |for signing, encryption and decryption on a user computer.
			           |
			           |Important: application and certificate with a private key must be installed
			           |on each computer which has 1C:Enterprise server
			           |or web server attached to the file infobase.'");
