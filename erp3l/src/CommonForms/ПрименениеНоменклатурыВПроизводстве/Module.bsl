...
Процедура ПриОткрытии(Отказ)
	...
	Если НЕ ЗначениеЗаполнено(ОснованиеНоменклатура) Тогда
		...
		ТекстПредупреждения = НСтр("ru = 'Форма ""Производство"" используется только в контексте номенклатуры.';
									|en = '""Production"" form is used only within the context of inventory.'");
...
Процедура ЗаполнитьУправлениеСпецификациями(ТекущаяСпецификацияХарактеристика = Неопределено)
	...
	Запрос.Текст = УправлениеДаннымиОбИзделиях.ТекстЗапросаСпецификацийНоменклатуры(ПараметрыЗапросаСпецификаций, СписокПараметрыВыбораСпецификаций);
	УправлениеДаннымиОбИзделиях.УстановитьПараметрыЗапросаСпецификацийНоменклатуры(Запрос, СписокПараметрыВыбораСпецификаций);
...
Процедура УстановитьВидимостьЭлементовПараметраНазначения(ИмяПараметра, ВидимостьГруппы)
	...
	Если НЕ УправлениеДаннымиОбИзделияхПовтИсп.ПараметрНазначенияИспользуется(
