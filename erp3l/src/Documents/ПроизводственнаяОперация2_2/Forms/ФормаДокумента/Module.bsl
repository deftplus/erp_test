...
Процедура КоличествоФактПриИзменении(Элемент)
	...
	Если Объект.НаОснованииНСИ Тогда
		...
		ТекстВопроса = СтрШаблон(
			НСтр("ru = 'Заполнить материалы, изделия и трудозатраты %1?';
				|en = 'Populate materials, finished products and labor costs for %1?'"),
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("Статус") ИЛИ Инициализация Тогда
		...
		Элементы.ВыполнениеНачато.Видимость         = ОтображатьФакт И НЕ Форма.ЭтоМобильныйКлиент;
		Элементы.ВыполнениеЗавершено.Видимость      = ОтображатьФакт И НЕ Форма.ЭтоМобильныйКлиент;
		...
		Элементы.ЕдиницаИзмеренияПредставлениеФакт.Видимость = ОтображатьФакт И НЕ Форма.ЭтоМобильныйКлиент;
...
&НаСервере
Процедура ЗаполнитьПоНормативамОперацииНаСервере() 
	
	ДокументОбъект = РеквизитФормыВЗначение("Объект");
	ДокументОбъект.ЗаполнитьПоНормативамОперации();
...
Процедура ПриСменеСтраницы()
	...
	НастроитьЗависимыеЭлементыФормы(ЭтаФорма, "ГруппаСтраницы");
