...
Процедура ОбработкаПолученияПредставления(Данные, Представление, СтандартнаяОбработка)
	...
	ИначеЕсли РасхожденияКлиентСервер.ТипОснованияПередачаТоваровХранителю(Данные.ТипОснованияАктаОРасхождении) Тогда
		ПостфиксИмениДокумента = НСтр("ru = 'после передачи товаров хранителю';
										|en = 'after goods transfer to bailee'");
	Иначе
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Populates the ""VAT rate"" attribute
	|Populates the ""Operating unit"" attribute in table ""Goods"" for ""Work"" type items.'");
