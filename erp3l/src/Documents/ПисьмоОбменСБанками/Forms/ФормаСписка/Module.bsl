...
Процедура СформироватьТаблицуБыстрогоОтбора()
	...
	ДобавитьСтрокуОтбора(
		"Основание", НСтр("ru = 'Основание:';
							|en = 'Basis:'"), "ОпределяемыеТипы.ВладелецОбменСБанками", , МассивВыбора);
	...
	Иначе
		ДобавитьСтрокуОтбора("СчетОрганизации", НСтр("ru = 'Счет:';
													|en = 'Account:'"), "ОпределяемыеТипы.СчетОрганизацииОбменСБанками", ,
	...
	Иначе
		ДобавитьСтрокуОтбора("Банк", НСтр("ru = 'Банк:';
											|en = 'Account:'"), "СправочникСсылка."+ НазваниеСправочникаБанки, , Банки);
	КонецЕсли;
