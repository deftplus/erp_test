			...
			Если ПрочиеРасходы.Количество()
				...
				Если Не Результат.Пустой() Тогда
					ОбщегоНазначенияКлиентСервер.СообщитьПользователю(
						НСтр("ru = 'Давальческие материалы/продукцию запрещено списывать на расходы.';
							|en = 'It is not allowed to write-off the provided materials/product as expenses.'"),,,, Отказ);
				КонецЕсли;
