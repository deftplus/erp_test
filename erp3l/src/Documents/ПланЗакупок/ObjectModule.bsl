...
Процедура ОбновитьЗамещенныеПланы()
	...
	Если Документы.ПланЗакупок.ЭтоПотребностиДляКЗ(ЭтотОбъект) Тогда
		...
		ТекстЗамены = ТекстДляЗамены + "
			//|	И ПланЗакупок.РежимФормированияПотребностейПланомЗакупок = ПланЗакупокЗамещенный.РежимФормированияПотребностейПланомЗакупок
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ВидБюджетаЗаявки = Перечисления.ПредназначенияЭлементовСтруктурыОтчета.БюджетДвиженияРесурсов;
...
Процедура ЗаполнитьРеквизитыПланаПоСценариюВидуПлана()
	...
	#Область УХ_Внедрение
	РеквизитыСценария = РеквизитыСценария + ", РежимФормированияПотребностейПланомЗакупок";
	#КонецОбласти
