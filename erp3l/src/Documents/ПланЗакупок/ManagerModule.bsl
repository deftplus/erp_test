...
Функция ЗапросЗамещенныеИЗамещающиеПланы(Параметры) Экспорт
	...
	Если ЭтоПланированиеПотребностей(Параметры.РежимФормированияПотребностейПланомЗакупок) Тогда
		...
		// Оставляем пока старые отборы
		//// Убираем старые отборы
		...
		//Запрос.Текст = СтрЗаменить(Запрос.Текст, ТекстДляЗамены, ТекстЗамены);
		//
		//ТекстДляЗамены = "И ПланЗакупокЗамещенный.Подразделение = &Подразделение";
		//ТекстЗамены = "И Истина";
		//Запрос.Текст = СтрЗаменить(Запрос.Текст, ТекстДляЗамены, ТекстЗамены);
		//
		//ТекстДляЗамены = "И ПланЗакупокЗамещенный.Склад = &Склад";
		//ТекстЗамены = "И Истина";
		//Запрос.Текст = СтрЗаменить(Запрос.Текст, ТекстДляЗамены, ТекстЗамены);
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Substitutes the purchases plans:
...
Функция ЭтоПотребностиДляКЗ(Данные) Экспорт
	...
	Режимы = Перечисления.РежимыФормированияПотребностейПланомЗакупок;
	ТекущийРежим = Данные.РежимФормированияПотребностейПланомЗакупок;
	
	Возврат ТекущийРежим = Режимы.РегистрируютПотребности
		ИЛИ ТекущийРежим = Режимы.ФормируютПотребности;
