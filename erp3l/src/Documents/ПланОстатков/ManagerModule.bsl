...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Substitutes the plans of goods stock:
	|- in the plans in the Confirmed status, the check box ""Замещен"" is selected, if there are plans in the ""In progress"" status for the plan
	| - in the plans in the Canceled status, the check box ""Замещен"" is unselected'");
