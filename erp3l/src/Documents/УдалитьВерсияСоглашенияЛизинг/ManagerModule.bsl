...
Функция ОписаниеГрафика(Знач ВидДоговораУХ = Неопределено) Экспорт
	...
	Если ВидДоговораУХ = Неопределено Тогда
		ВидДоговораУХ = Справочники.ВидыДоговоровКонтрагентовУХ.ЛизингПолученный;
	КонецЕсли;
	
	Результат = Новый Структура;
	
	// Услуги по лизингу
	Секция = ФинансовыеИнструментыФормыКлиентСервер.ОписаниеСекцииГрафика();
	Секция.Имя = "УслугаПоАренде";
	Секция.КолонкаПриход = "УслугаПоАрендеНачисление";
	Секция.КолонкаРасход = "УслугаПоАрендеОплата";
	Секция.КолонкаРасходДДС = Истина;	
	Секция.КолонкаОстаток = "УслугаПоАрендеЗадолженность";
	Секция.Представление = Нстр("ru = 'Услуга по лизингу'");
	Секция.КолонкаПриходПредставление = Нстр("ru = 'Начисление'");
	Секция.КолонкаРасходПредставление = Нстр("ru = 'Оплата'");
	Секция.КолонкаОстатокПредставление = Нстр("ru = 'Остаток'");
	Секция.ЭлементСтруктурыЗадолженности = Перечисления.ЭлементыСтруктурыЗадолженности.УслугаПоАренде;
	
	Результат.Вставить(Секция.Имя,        Секция);
	
	// Зачет обеспечительного платежа
	Секция = ФинансовыеИнструментыФормыКлиентСервер.ОписаниеСекцииГрафика();
	Секция.Имя = "ОбеспечительныйПлатеж";
	Секция.КолонкаПриход = "ОбеспечительныйПлатежНачисление";
	Секция.КолонкаРасход = "ОбеспечительныйПлатежОплата";
	Секция.КолонкаРасходДДС = Истина;	
	Секция.КолонкаОстаток = "ОбеспечительныйПлатежЗадолженность";
	Секция.Представление = Нстр("ru = 'Обеспечительный платеж'");
	Секция.КолонкаПриходПредставление = Нстр("ru = 'Начисление'");
	Секция.КолонкаРасходПредставление = Нстр("ru = 'Оплата'");
	Секция.КолонкаОстатокПредставление = Нстр("ru = 'Остаток'");
	Секция.ЭлементСтруктурыЗадолженности = Перечисления.ЭлементыСтруктурыЗадолженности.ОбеспечительныйПлатеж;
	
	Результат.Вставить(Секция.Имя,        Секция);
	
	// Выкуп предмета лизинга
	Секция = ФинансовыеИнструментыФормыКлиентСервер.ОписаниеСекцииГрафика();
	Секция.Имя = "ВыкупнаяСтоимость";
	Секция.КолонкаПриход = "ВыкупнаяСтоимостьНачисление";
	Секция.КолонкаРасход = "ВыкупнаяСтоимостьОплата";
	Секция.КолонкаРасходДДС = Истина;	
	Секция.КолонкаОстаток = "ВыкупнаяСтоимостьЗадолженность";
	Секция.Представление = Нстр("ru = 'Выкуп предмета лизинга'");
	Секция.КолонкаПриходПредставление = Нстр("ru = 'Начисление'");
	Секция.КолонкаРасходПредставление = Нстр("ru = 'Оплата'");
	Секция.КолонкаОстатокПредставление = Нстр("ru = 'Остаток'");
	Секция.ЭлементСтруктурыЗадолженности = Перечисления.ЭлементыСтруктурыЗадолженности.ВыкупнаяСтоимость;
...
Функция ИменаКлючевыхРеквизитов() Экспорт
	...
	Результат.ДатаНачалаДействия = "ГраницаФактическихДанных";
...
Функция ПредставленияКолонокГрафика() Экспорт
	...
	ПредставленияКолонок.Вставить("УслугаПоЛизингуНачисление",				НСтр("ru = 'Начисление за услугу лизинга'"));
	ПредставленияКолонок.Вставить("УслугаПоЛизингуОплата",					НСтр("ru = 'Оплата услуги лизинга'"));
	ПредставленияКолонок.Вставить("ОбеспечительныйПлатежНачисление",	НСтр("ru = 'Начисление по обеспечительному платежу'"));
	ПредставленияКолонок.Вставить("ОбеспечительныйПлатежОплата",		НСтр("ru = 'Оплата по обеспечительному платежу'"));
	ПредставленияКолонок.Вставить("ВыкупнойПлатежНачисление",			НСтр("ru = 'Начисление по выкупу предмета лизинга'"));
	ПредставленияКолонок.Вставить("ВыкупнойПлатежОплата",				НСтр("ru = 'Оплата выкупа предмета лизинга'"));
...
Функция ИмяТаблицыДокумента()
	Возврат "Документ.УдалитьВерсияСоглашенияЛизинг";
КонецФункции
...
Функция ПланыДокумента(Источник) Экспорт
	...
	ИначеЕсли ТипЗнч(Источник) = Тип("ДокументОбъект.УдалитьВерсияСоглашенияЛизинг") Тогда
