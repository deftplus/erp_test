...
Процедура УправлениеОКТМО(Форма)
	...
	Если Форма.ОКТМООбрезан Тогда
		Шаблон = НСтр("ru = 'В соответствии с требованиями формата ОКТМО %1 был обрезан до 8 символов';
						|en = 'В соответствии с требованиями формата ОКТМО %1 был обрезан до 8 символов'");
	...
	Иначе
		Текст = НСтр("ru = 'В соответствии с требованиями формата ОКТМО должен быть длиной 8 символов. Если ваш ОКТМО длинной 11 символов, его нужно сократить до 8';
					|en = 'В соответствии с требованиями формата ОКТМО должен быть длиной 8 символов. Если ваш ОКТМО длинной 11 символов, его нужно сократить до 8'");
	КонецЕсли;
