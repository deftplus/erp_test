...
Процедура УстановитьОформлениеЭлементаДоступно()
	...
	ЭтоСборка = Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СборкаТоваров;
	Элементы.Доступно.Видимость = Не ЭтоСборка И Объект.ВариантОбеспечения = Перечисления.ВариантыОбеспечения.Требуется;
	Элементы.НадписьУпаковка.Видимость = Не ЭтоСборка И Объект.ВариантОбеспечения = Перечисления.ВариантыОбеспечения.Требуется;	
