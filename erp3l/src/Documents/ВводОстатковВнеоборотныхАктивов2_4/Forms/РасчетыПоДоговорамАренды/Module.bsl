...
Процедура Подключаемый_СообщитьЧтоФормаУстарела()
	...
	ТекстВопроса = НСтр("ru = 'Ввод остатков взаиморасчетов по аренде с помощью документа ""Ввод остатков внеоборотных активов"" устарел.
						...
						|en = 'Entry of the lease AR/AP balance using the ""OB entry: Fixed assets cost and depreciation"" document is outdated.
						|It is recommended that you use the document only for viewing previously created documents.
						|If the outdated document must be changed, create new document ""OB entry: lease AR/AP"" and delete the outdated one.
						|To create new documents, use the ""OB entry: lease AR/AP"" documents.'");
