...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	|			ГДЕ
	|				ТЧРасшифровкаПлатежа.Ссылка = СписаниеПринятыхНаХранениеТоваров.Ссылка
	...
	|	ИЛИ СписаниеПринятыхНаХранениеТоваров.ОбъектРасчетов = ЗНАЧЕНИЕ(Справочник.ОбъектыРасчетов.ПустаяСсылка)
	|	ИЛИ СписаниеПринятыхНаХранениеТоваров.ИдентификаторДокумента = """"
	//++ НЕ УТ
	|	ИЛИ (СписаниеПринятыхНаХранениеТоваров.УдалитьСчетУчета <> &СчетУчетаПустаяСсылка И
	|		СписаниеПринятыхНаХранениеТоваров.НастройкаСчетовУчета = ЗНАЧЕНИЕ(Справочник.НастройкиСчетовУчетаПрочихОпераций.ПустаяСсылка))
	//-- НЕ УТ
	|");
