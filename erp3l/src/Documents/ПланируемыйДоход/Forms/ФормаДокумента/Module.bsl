...
Процедура УправлениеФормой()
	...
	ЕстьДоговорКредитаДепозита = (Объект.ВидОперацииУХ = Справочники.ВидыОперацийУХ.ДоходыПоДепозитам);
	...
	Элементы.ДоговорКредитаДепозита.Видимость = ЕстьДоговорКредитаДепозита;
	Элементы.ДоговорКредитаДепозита.ТолькоПросмотр = Не ЗначениеЗаполнено(Объект.Организация) ИЛИ НЕ ЗначениеЗаполнено(Объект.Контрагент);
	#КонецОбласти
