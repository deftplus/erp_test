...
Процедура ОрганизацияПриИзмененииСервер()
	...
	ИзменениеПараметровОСЛокализация.ОрганизацияПриИзменении(ЭтотОбъект);
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, Знач ИзмененныеРеквизитыИлиЭлемент = "")
	...
	Если ОбновитьВсе Тогда
		Элементы.ГруппаПараметрыУУ.ОтображатьЗаголовок = Ложь;
...
Процедура УстановитьВидимостьТекущихЗначений(Форма, ОбновитьВсе, СтруктураИзмененныхРеквизитов)
	...
	СвойстваОбщ = Новый Структура("ОбъемНаработки,ПоказательНаработки,ГруппаФинансовогоУчета,НаправлениеДеятельности");
	
	СвойстваПрочее = Новый Структура;
	СвойстваПрочее.Вставить("ОССрокИспользованияДляВычисленияАмортизацииУУ", "СрокИспользованияУУ");
	СвойстваПрочее.Вставить("ОСОбъемПродукцииРаботДляВычисленияАмортизации", "ОбъемНаработки");
