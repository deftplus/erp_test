...
Процедура УстановитьУсловноеОформление()
	...
	УчетПрослеживаемыхТоваровЛокализация.УстановитьУсловноеОформлениеКоличестваПоРНПТ(ЭтаФорма,"ПриходуемыеМЦКоличествоПоРНПТ");
	
	НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(
		ЭтотОбъект, "ПриходуемыеМЦХарактеристика", "Объект.ПриходуемыеМЦ.ХарактеристикиИспользуются");
...
Процедура ПриЧтенииСозданииНаСервере()
	...
	СписаниеОСЛокализация.ПриЧтенииСозданииНаСервере(ЭтотОбъект);
...
Процедура ЗаполнитьПараметрыВыбора()
	...
	СписокПараметровВыбора = Новый Массив(Элементы.ОСОсновноеСредство.ПараметрыВыбора);
...
Процедура ЗаполнитьСуммуСписанияНаСервере()
	...
	//++ Локализация
	СписаниеОСЛокализация.ЗаполнитьСуммуСписанияНаОснованииВыбытияТМЦ(Объект);
	//-- Локализация
