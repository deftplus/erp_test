...
Процедура ПриЗаполненииСсылокРодственников(Больничный, РодственникиЭЛН) Экспорт
	ФизическоеЛицо = Больничный.ФизическоеЛицо;
	...
	Для Каждого РодственникЭЛН Из РодственникиТребующиеЗаполнения Цикл
		Для Каждого Ключ Из РодственникЭЛН.Ключи Цикл
			...
			ОбновитьРеквизитыРодственникаИБ(РодственникЭЛН, РодственникИБ, БыстрыйПоискРодственников);
			Прервать;
		КонецЦикла;
		Если Не ЗначениеЗаполнено(РодственникЭЛН.Ссылка)
			...
			РодственникЭЛН.Ссылка = СоздатьРодственникаИБ(ФизическоеЛицо, РодственникЭЛН, БыстрыйПоискРодственников);
		КонецЕсли;
	КонецЦикла;
...
Функция СоздатьРодственникаИБ(ФизическоеЛицо, РодственникЭЛН, БыстрыйПоискРодственников)
...
Процедура ОбновитьРеквизитыРодственникаИБ(РодственникЭЛН, РодственникИБ, БыстрыйПоискРодственников)
