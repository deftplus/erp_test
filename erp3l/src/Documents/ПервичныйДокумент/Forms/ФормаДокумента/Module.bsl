...
Процедура ДоговорПриИзмененииСервер()
	...
	Если ЗначениеЗаполнено(Объект.Договор) Тогда
		...
		ПорядокРасчетовПоДоговоры       = Перечисления.ПорядокРасчетов.ПустаяСсылка();
		...
		Если ТипЗнч(Объект.Договор) = Тип("СправочникСсылка.ДоговорыКонтрагентов")
			...
			РеквизитыДоговора = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Объект.Договор, "ПорядокРасчетов, НалогообложениеНДС, НаправлениеДеятельности");
			
			ПорядокРасчетовПоДоговоры       = РеквизитыДоговора.ПорядокРасчетов;
			НалогообложениеНДСДоговора      = РеквизитыДоговора.НалогообложениеНДС;
			НаправлениеДеятельностиДоговора = РеквизитыДоговора.НаправлениеДеятельности;
		...
		ИначеЕсли ТипЗнч(Объект.Договор) = Тип("СправочникСсылка.ДоговорыАренды") Тогда
			...
			НалогообложениеНДСДоговора      = Перечисления.ТипыНалогообложенияНДС.ПродажаОблагаетсяНДС;
			НаправлениеДеятельностиДоговора = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Объект.Договор, "НаправлениеДеятельности");
		//-- НЕ УТ
		КонецЕсли;
		...
		Если Объект.ПорядокРасчетов = Перечисления.ПорядокРасчетов.ПоЗаказам
			...
			Объект.НаправлениеДеятельности = НаправлениеДеятельностиДоговора;
		Иначе
			Объект.НаправлениеДеятельности = Справочники.НаправленияДеятельности.ПустаяСсылка();
		КонецЕсли;
	КонецЕсли;
