...
#Область ПоступлениеОплатыОтКлиента
	...
	|	ЗНАЧЕНИЕ(Справочник.ДоговорыЭквайринга.ПустаяСсылка) КАК АналитикаУчетаДт,
	...
	|	ЗНАЧЕНИЕ(Справочник.ДоговорыЭквайринга.ПустаяСсылка) КАК СубконтоДт2,
...
#Область ВозвратОплатыКлиенту
	...
	|	ЗНАЧЕНИЕ(Справочник.ДоговорыЭквайринга.ПустаяСсылка) КАК СубконтоКт2,
	|	НЕОПРЕДЕЛЕНО КАК СубконтоКт3,
	|
...
Функция ОснованиеПлатежаПоУИП(Организация, УИП) Экспорт
	...
	ВзаиморасчетыСервер.ЗаполнитьДанныеВыбораОснованияПлатежа(ДанныеВыбора,
		 Новый Структура("Организация, Текст, ТипРасчетов", 
		 	Организация, УИП, Перечисления.ТипыРасчетовСПартнерами.РасчетыСКлиентом), Ложь, Истина);
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Заполняет реквизит ОбъектРасчетов и ИдентификаторДокумента.';
									|en = 'Fills in ОбъектРасчетов and ИдентификаторДокумента attributes.'");
