...
Функция ПолучитьВидыПризнанияБУ_УУ()
	...
	Если Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ЗавершениеЭтаповИсследованийИРазработок Тогда
		...
		Если ИспользоватьПроизводство Тогда
			СписокВидовПризнания.Добавить(Перечисления.ВидыПризнанияРасходовПоИсследованиямИРазработкам.ВключитьВСоставПроизводственныхЗатрат);
		КонецЕсли;
...
Функция ПолучитьВидыПризнанияНУ(ВидПризнанияБУ)
	...
	ИначеЕсли ВидПризнанияБУ = Перечисления.ВидыПризнанияРасходовПоИсследованиямИРазработкам.ВключитьВСоставПроизводственныхЗатрат Тогда
		СписокПризнанийНУ.Добавить(Перечисления.ВидыПризнанияРасходовПоИсследованиямИРазработкам.ВключитьВСоставПроизводственныхЗатрат);
		СписокПризнанийНУ.Добавить(Перечисления.ВидыПризнанияРасходовПоИсследованиямИРазработкам.ПризнаниеВСоставеТекущихРасходов);
...
Процедура НастроитьХозяйственныеОперации()
	...
	Если Не Объект.Организация.Пустая() Тогда
		...
		НастройкиПризнанияИсследований.Загрузить(
			УчетРасходовПоИсследованиямИРазработкам.НастройкиПризнанияРасходовПоИсследованийОрганизаций(Объект.Дата, Организации));
