...
Процедура НастроитьЗависимыеЭлементыФормыНаСервере(Знач ИзмененныеРеквизиты = "")
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("ОсновноеСредство")
		...
		ЗначениеВидно = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ОсновноеСредство, "ТипОС")
	...
	Если ОбновитьВсе Тогда
		...
		Элементы.ДекорацияЛиквидационнаяСтоимостьНУ.Видимость = Ложь;
		Элементы.ДекорацияЛиквидационнаяСтоимостьПР.Видимость = Ложь;
		Элементы.ДекорацияЛиквидационнаяСтоимостьВР.Видимость = Ложь;
