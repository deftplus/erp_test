...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	ЗначенияПоУмолчанию = ПолучитьПоНоменклатуреЗначенияПоУмолчаниюНаСервере(ТекущиеДанные.Номенклатура);
...
&НаСервере
Функция ПолучитьПоНоменклатуреЗначенияПоУмолчаниюНаСервере(Номенклатура)
