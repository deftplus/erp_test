	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "Накладная") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, "Накладная",
			НСтр("ru = 'Оприходование товаров';
				|en = 'Recording goods as received'"), СформироватьПечатнуюФормуНакладная(МассивОбъектов, ОбъектыПечати));
	КонецЕсли;
...
Функция СформироватьПечатнуюФормуНакладная(МассивОбъектов, ОбъектыПечати)
	...
	СинонимДокумента = НСтр("ru = 'Оприходование товаров';
							|en = 'Recording goods as received'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Updates the ""Other receipt of goods"" document:
	|- Fills in the ""Line ID"" field attribute in tables.
	|- Fills in the ""Ledger account settings"" attribute.
	|- Fills in attributes ""Batch specification status (sender)"", ""Batch specification status (recipient)"" in the ""Goods"" table.
	|- Fills in the ""Lot"" attribute with a new lot in the ""Goods"" table.
	|- Fills in the ""Inv. No."" attribute in the ""Goods"" table.
	|- Fills in the ""Line of business"" attribute in the ""Goods"" table.'");
