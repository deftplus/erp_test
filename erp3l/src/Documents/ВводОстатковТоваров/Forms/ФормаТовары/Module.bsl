	...
	Если ПоЗаказу Тогда
		Если Объект.Товары.Количество() > 0 Тогда
			...
			ТекстВопроса = НСтр("ru = 'Список переданных переработчику товаров будет очищен. Продолжить?';
								|en = 'List of goods transferred to the subcontractor will be cleared. Continue?'");
...
Процедура УстановитьВидимость()
	...
	Элементы.СобственныеТоварыУказатьДокументыПоступления.Видимость = Не ПолучитьФункциональнуюОпцию("ЛокализацияРФ");
