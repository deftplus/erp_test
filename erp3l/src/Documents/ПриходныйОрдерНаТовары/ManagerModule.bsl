...
//++ НЕ УТ
	...
	ИначеЕсли ТипЗнч(Объект.Распоряжение) = Тип("ДокументСсылка.ЭтапПроизводства2_2") Тогда
		...
		|			И ВыходныеИзделия.Отменено = ТаблицаСерииВыходныеИзделия.Отменено
		...
		|			И ВыходныеИзделия.Подразделение = ТаблицаСерииВыходныеИзделия.Подразделение
		|	ГДЕ
		|		ВыходныеИзделия.Ссылка = &Распоряжение
		|		И ВыходныеИзделия.Получатель = &Склад
		|		И ВыходныеИзделия.Ссылка.Проведен
		...
		|			И ПобочныеИзделия.Отменено = ТаблицаСерииПобочныеИзделия.Отменено
		...
		|			И ПобочныеИзделия.Подразделение = ТаблицаСерииПобочныеИзделия.Подразделение
		|	ГДЕ
