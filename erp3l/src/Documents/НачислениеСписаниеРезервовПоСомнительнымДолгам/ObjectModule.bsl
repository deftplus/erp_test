...
Процедура ЗаполнитьДебиторскуюЗадолженность(ДанныеДебиторскойЗадолженности, РассчитыватьРезервы = Истина) Экспорт
	...
	ТаблицаОценкиБУ = НачислениеСписаниеРезервовПоСомнительнымДолгамЛокализация.ТаблицаОценкиБУ(Организация, Дата);
	ПараметрыОценки = Новый Структура("ТаблицаОценки", ТаблицаОценкиБУ);
	ТаблицаОценкиСроков = ТаблицаОценкиСроковБУ(ТаблицаОценкиБУ);
...
Функция ТаблицаОценкиСроковБУ(ТаблицаОценкиБУ)
