...
Процедура УстановитьУчетнуюПолитикуОрганизаций()
	...
	ПараметрыУчетныхПолитик = НачислениеСписаниеРезервовПоСомнительнымДолгамЛокализация.ПолучитьДействующиеПараметрыУчетныхПолитик(
		Объект.Организация,
		Объект.Дата);
	
	ПараметрыУчетнойПолитики = ПараметрыУчетныхПолитик.УчетнаяПолитикаБухУчета;
...
Процедура КомандаОткрытьУчетнуюПолитикуОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	СтандартнаяОбработка = Ложь;
	//++ Локализация
	Если НавигационнаяСсылкаФорматированнойСтроки = "ОткрытьУчетнуюПолитикуБУ" Тогда
		ОткрытьФорму("РегистрСведений.УчетнаяПолитикаБухУчета.ФормаЗаписи",
			ПараметрыОткрытияФормыУчетнойПолитики("УчетнаяПолитикаБухУчета",
				Объект.Организация,
				Объект.Дата),
			ЭтаФорма,,,,,
