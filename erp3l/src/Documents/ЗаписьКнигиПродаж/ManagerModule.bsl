...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Populates ""VAT rate"" attribute
	|Populates the ""GL account settings"" tabular sections attribute.'");
	...
	//++ НЕ УТ
	Изменяемые.Добавить(Метаданные.Справочники.НастройкиСчетовУчетаПрочихОпераций.ПолноеИмя());
	//-- НЕ УТ
	...
	//++ НЕ УТ
	Блокируемые.Добавить(Метаданные.Справочники.НастройкиСчетовУчетаПрочихОпераций.ПолноеИмя());
	//-- НЕ УТ
...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	//++ НЕ УТ
	|				ИЛИ ЗаписьКнигиПродажЦенности.УдалитьСчетУчета <> &СчетУчетаПустаяСсылка
	|					И ЗаписьКнигиПродажЦенности.НастройкаСчетовУчета = ЗНАЧЕНИЕ(Справочник.НастройкиСчетовУчетаПрочихОпераций.ПустаяСсылка)
	//-- НЕ УТ
	|			))
	|	ИЛИ ИСТИНА В
	|		(ВЫБРАТЬ ПЕРВЫЕ 1
	...
	//++ НЕ УТ
	|				ИЛИ ЗаписьКнигиПродажРасхождения.УдалитьСчетУчета <> &СчетУчетаПустаяСсылка
	|					И ЗаписьКнигиПродажРасхождения.НастройкаСчетовУчета = ЗНАЧЕНИЕ(Справочник.НастройкиСчетовУчетаПрочихОпераций.ПустаяСсылка)
	//-- НЕ УТ
	|			)))";
