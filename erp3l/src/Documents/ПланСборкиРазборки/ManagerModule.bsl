...
#Область ПланыСборкиКомплектующие
	...
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru = 'План сборки (комплектующие)';
														|en = 'Assembly schedule (components)'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланыСборки);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
...
#Область ПланыРазборкиКомплектующие
	...
	ДопПараметр.Вставить("Заголовок", 			НСтр("ru = 'План разборки (комплектующие)';
														|en = 'Disassembly schedule (components)'"));
	ДопПараметр.Вставить("СоздаватьРеквизит", 	ИспользоватьПланыСборки);
	ДопПараметр.Вставить("УдалятьРеквизитыТаблицы", Истина);
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Представление = НСтр("ru = 'План сборки (разборки)';
										|en = 'Assembly (disassembly) schedule'");
		...
		Если ВыводитьШапку Тогда
			...
			Если ДанныеПечати.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.СборкаТоваров Тогда
				ШаблонЗагловка = НСтр("ru = 'План сборки';
										|en = 'Assembly schedule'", ОбщегоНазначения.КодОсновногоЯзыка());
			Иначе
				ШаблонЗагловка = НСтр("ru = 'План разборки';
										|en = 'Disassembly schedule'", ОбщегоНазначения.КодОсновногоЯзыка());
			КонецЕсли; 
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	|en = 'Substitutes the assembly (disassembly) schedules:
	|-in the schedules in the Confirmed status, the check box ""Substituted to order"" is selected, if there are schedules in the Confirmed status for the schedule
	| - in the schedules in the Confirmed status, the check box ""Substituted"" is selected, if there are schedules in the ""In progress"" status for the schedule
	| - in the schedules in the Canceled status, the check box ""Substituted"" is cleared'");
...
Процедура ПриЗаполненииСпискаТекущихДел(ТекущиеДела) Экспорт
	...
	Дело.Представление  = НСтр("ru = 'Планы сборки (разборки)';
								|en = 'Assembly (disassembly) schedules'");
