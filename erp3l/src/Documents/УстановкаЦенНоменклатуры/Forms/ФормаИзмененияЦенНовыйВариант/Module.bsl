	...
	Для Каждого ВидЦены Из ВидыЦен Цикл
		Если ВидЦены.Пересчитать Тогда
			...
			ИначеЕсли ВариантИзмененияЦены = 2 Тогда // изменить на значение
				МассивВидовЦен.Добавить(Новый Структура("ВидЦены, СуммаИзменения", ВидЦены.Ссылка, ВидЦены.СуммаИзменения));
			ИначеЕсли ВариантИзмененияЦены = 3 Тогда // установить значение
			...
			ИначеЕсли ВариантИзмененияЦены = 5 Тогда //
