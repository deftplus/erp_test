...
Процедура ОформитьВозврат(Команда)
	...
	Если ПодобраноПозиций = 0 Тогда
		...
		Возврат;
	Иначе
		ОткрытьФормуРМКДляОформленияЧекаККМВозврат(Истина);	
		Закрыть();
	КонецЕсли;
...
&НаКлиенте
Процедура ОткрытьФормуРМКДляОформленияЧекаККМВозврат(ОформитьВозвратНаОснованииЧекаККМ = Истина)

	ПараметрыОткрытия = Новый Структура;
		
	Если ОформитьВозвратНаОснованииЧекаККМ Тогда
