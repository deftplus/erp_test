...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновляет документы ""Ввод остатков внеоборотных активов (2.2)"":
	|- заполняет новый реквизит ""Направление деятельности"".';
	|en = 'Updates the ""Capital assets balance entry (2.2)"" documents:
