...
Процедура ВыполнитьКонтрольКорректностиЗаполненияПрослеживаемыхТоваров(Отказ)
	...
	ШаблонТекстаОшибки =
		...
		|en = 'No balance was found in the Company goods register by the quantity of RNPT (goods batch registration number) for goods %1. 
		|Register a Notification of traceable goods import document.'");
