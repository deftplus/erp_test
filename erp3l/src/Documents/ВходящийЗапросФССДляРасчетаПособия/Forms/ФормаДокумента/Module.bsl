...
Функция ПодготовитьВопросВПоддержку()
	...
	Если ЗначениеЗаполнено(ТекстXML) Тогда
		...
		Вложение.Представление = НСтр("ru = 'ЗапросСведенийДляРасчета';
										|en = 'ЗапросСведенийДляРасчета'") + "_" + Объект.ИдентификаторСообщения + ".xml";
	...
	Сообщение.Тема = НСтр("ru = 'Вопрос по СЭДО (тип 100: запрос сведений для расчета пособия ФСС) от %1 (%2)';
							|en = 'EDI question (type 100: information request for SSF allowance calculation) from %1 (%2)'");
