...
Процедура Подключаемый_ПроверитьВыполнениеЗаданияПоПолучениюДокументовНаОсновании()
	...
	Если ЗначениеЗаполнено(ДанныеПоФоновомуЗаданиюПолучениеДокументовНаОсновании) Тогда
		...
		Если ДанныеПоФоновомуЗаданиюПолучениеДокументовНаОсновании.Статус = "Выполнено"
			...
			ОбновитьТекстДокументыНаОсновании(ДанныеПоФоновомуЗаданиюПолучениеДокументовНаОсновании.АдресРезультата);
...
Функция ВариантОбеспеченияПоУмолчанию()
	...
	Если Объект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПоставкаПодПринципала Тогда
		ВариантИФлаг = Новый Структура("ВариантОбеспечения,Обособленно", Перечисления.ВариантыОбеспечения.Требуется, Истина);
	КонецЕсли;
...
&НаСервереБезКонтекста
Функция СписокТиповДокументовНавигационнойСсылки(Объект)
...
&НаСервере
Процедура ОбновитьТекстДокументыНаОсновании(АдресРезультата)
	...
	Если ЗначениеЗаполнено(Объект.Ссылка) Тогда
		...
		ПродажиСервер.СформироватьТекстыПолейДокументовНаОсновании(АдресРезультата,
			ТекстыПоляДокументыНаОсновании, ДокументыНаОсновании, СписокТиповДокументовНавигационнойСсылки(Объект));
