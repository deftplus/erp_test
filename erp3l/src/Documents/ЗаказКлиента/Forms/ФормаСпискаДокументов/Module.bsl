...
Процедура СписокПриИзменении(Элемент)
	...
	ОбеспечениеВДокументахКлиент.СписокПриИзменении(ЭтотОбъект,
		ПредопределенноеЗначение("Документ.ЗаказКлиента.ПустаяСсылка"));
...
Процедура ПолучитьНастройкуКомплектаДокументов(Команда)
	...
	Оповещение = Новый ОписаниеОповещения("ПолучитьНастройкуКомплектаДокументовЗавершение", ЭтотОбъект);
...
&НаКлиенте
Процедура ПолучитьНастройкуКомплектаДокументовЗавершение(Результат, ДополнительныеПараметры) Экспорт 
